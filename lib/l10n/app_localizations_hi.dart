...
class AppLocalizationsHi extends AppLocalizations {
  ...
  String get questionnaireExitDialog =>
      'इन प्रश्नों के उत्तर देने से आपकी आँखों की समस्याओं की पहचान में मदद मिलेगी। क्या आप वाकई बाहर निकलना चाहते हैं?';
  ...
  String get visualAcuityDescription =>
      'दृश्य तीक्ष्णता परीक्षण एक नेत्र परीक्षण है जो यह जाँचता है कि आप एक विशिष्ट दूरी से किसी अक्षर या प्रतीक का विवरण कितनी अच्छी तरह देखते हैं। यह त्वरित परीक्षण अभी करें!';
  ...
  String get visualAcuityViewStepsToPerform =>
      'दृश्य तीक्ष्णता परीक्षण करने की प्रक्रिया देखें';

  @override
  String get visualAcuityCompletionDialog =>
      'दृश्य तीक्ष्णता परीक्षण दोनों आँखों के लिए पूरा हो गया है। आगे आपको अपनी आंखों की तस्वीरें खींचनी होंगी।';

  @override
  String get visualAcuityExitDialog =>
      'दृश्य तीक्ष्णता परीक्षण आपकी आँख की समस्या के बारे में समझने के लिए एक महत्वपूर्ण परीक्षण है। क्या आप वाकई बाहर निकलना चाहते हैं?';
  ...
  String get visualAcuityLeftEyeInstructions =>
      'बिना पलक पर दबाव डाले, अपने हाथ से दाहिनी आँख को ढ़क लें। यदि आप चश्मा पहने हैं, तो चश्मे पर अपना हाथ रखें।';
  ...
  String get visualAcuityRightEyeInstructions =>
      'बिना पलक पर दबाव डाले, अपने हाथ से बाईं आँख को ढ़क लें। यदि आप चश्मा पहने हैं, तो चश्मे पर अपना हाथ रखें।';
  ...
  String get visualAcuityBothEyeInstructions =>
      'किसी भी आँख को ढ़कने का प्रयास न करें और आगे दिखाए गए प्रतीकों को दोनों आँखों से देखें।';
  ...
  String get overlayDescription =>
      'प्रत्येक चिन्ह की दिशा को इस प्रकार समझा जा सकता है।';
  ...
  String get eyeScanDescription =>
      'आप बहुत करीब हैं! सिर्फ एक परीक्षण बाकी है। अब अपनी आँखों की फ़ोटो लें।';
  ...
  String get eyeScanViewStepsToPerform =>
      'आँखों को स्कैन करने की प्रक्रिया देखें';

  @override
  String get eyeScanExitDialog =>
      'नेत्र स्कैन आपकी आँख की समस्या के बारे में और जानने में मदद करता है। क्या आप वाकई बाहर निकलना चाहते हैं?';
  ...
  String get homeCarousal1Title =>
      '40 वर्ष और उससे अधिक आयु के वयस्कों में मोतियाबिंद के प्रसार और उससे जुड़े कारक के बारे में जानें';

  @override
  String get homeCarousal1Description =>
      'मोतियाबिंद के प्रसार के सैम्पलिंग प्रक्रिया का तात्कालिक प्रस्तुतिकरण और इससे जुड़े कारकों का विस्तारपूर्ण विवरण';

  @override
  String get homeCarousal2Title =>
      '7 आँख समस्याएँ जिन्हें आप नजरअंदाज नहीं कर सकते!';
  ...
  String get privacyPolicyDataTransferDescription =>
      'आपके द्वारा साझा किये गए व्यक्तिगत डेटा को हमारे आंतरिक सर्वरों पर, हमारे अधिकृत सेवा प्रदाता के सर्वर पर भारत में संग्रहित किया जाएगा।';
  ...
  String get privacyPolicyDataSecurityDescription =>
      'एलवीपीईआई आपके व्यक्तिगत डेटा को सुरक्षित रखने के उचित और उपयुक्त सुरक्षा अभ्यास और प्रक्रियाओं का पालन करता है, जिसमें प्रशासनिक, भौतिक सुरक्षा, और तकनीकी नियंत्रण शामिल है।';
  ...
  String get privacyPolicyDataRetentionDescription =>
      'व्यक्तिगत डेटा जो कानूनी और व्यवसायिक आवश्यकताओं के रूप में रखने की आवश्यकता नहीं होती है, वह एक सुरक्षित तरीके से निष्क्रिय कर दिया जाएगा।';
  ...
  String get privacyPolicyDataSubjectRightsDescription =>
      'आपको किसी भी समय अपनी व्यक्तिगत जानकारी को हासिल करने और सुधारने का अधिकार है। किसी भी अनुरोध, समस्या, चिंता या पूछताछ के मामले में आप एलवी प्रसाद कार्यालय से ईमेल भेजकर <LVPEI को डेटा गुप्तिदान के लिए जेनेरिक मेल आईडी प्रदान करने के लिए> संपर्क कर सकते हैं।';
  ...
  String get assessmentAndTestsSubtitle =>
      'अब तक किए गए मूल्यांकन का त्वरित दृश्यण।';
  ...
  String get eyeAssessmentSubtitle =>
      'कुछ चरणों में अपने, अपने दोस्तों और परिवार के सदस्यों के नेत्र संकटों का मूल्यांकन करें। आपसे आपके नेत्र संकटों से संबंधित लक्षणों को समझने के लिए कुछ सवाल पूछे जाएंगे और फिर कुछ दृष्टि परीक्षण होंगे।';
  ...
  String get eyeAssessmentBrightnessError =>
      'कृपया ब्राइटनेस को मैन्युअल रूप से 80% पर सेट करें';
  ...
  String get eyeAssessmentPopUpBody =>
      'क्या आपके कोई दृष्टि संबंधित समस्या है?';
  ...
  String get visualAcuityTestInstructionOne =>
      'एक आरामदायक और अच्छी रौशनी वाले स्थान पर बैठें। आपको ब्राइटनेस में एक अचानक बदलाव महसूस हो सकता है, चिंता न करें, स्क्रीन को ऑटो-ब्राइटनेस पर सेट किया गया है ताकि आपको सर्वोत्तम परिणाम प्रदान किया जा सके';

  @override
  String get visualAcuityTestInstructionTwo =>
      'सुनिश्चित करें कि आप डिवाइस को आंख के स्तर पर पकड़ रहे हैं। यदि आप चश्मा या कॉन्टैक्ट लेंस पहनते हैं, तो उन्हें लगाए रखें';

  @override
  String get visualAcuityTestInstructionThree =>
      'अपने आप को स्क्रीन से 40 सेमी की दूरी पर रखें। दूरी परीक्षण स्क्रीन में दिखाई जाएगी.';

  @override
  String get visualAcuityTestInstructionFour =>
      'यदि आप चश्मा पहनकर परीक्षण कर रहे हैं, तो एक नेत्र को आपके चश्मे के ऊपर अपने हाथ से ढ़क लें जब केवल एक नेत्र का परीक्षण होता है।';
  ...
  String get eyeAssessmentCompleteSteps =>
      'परिणाम देखने के लिए सभी चरण पूरे करें';

  @override
  String get eyeAssessmentToolTip =>
      'कृपया सुनिश्चित करें कि फ्लैश बंद है और ब्राइटनेस 80% पर सेट है';

  @override
  String get eyeScanInstructionOne =>
      'चेहरे को फ्रेम पर ठीक से रखकर कैमरा पकड़ें।';

  @override
  String get eyeScanInstructionTwo =>
      'अपने फ़ोन के पिछले कैमरे का उपयोग करके आँखों की तस्वीर लें।';

  @override
  String get eyeScanInstructionThree =>
      'सुनिश्चित करें कि आप फ़्लैश चालू रखते हुए अच्छी रोशनी वाले क्षेत्र में हों।';

  @override
  String get eyeScanInstructionFour =>
      'बेहतर कैप्चर और स्पष्टता के लिए, किसी और को तस्वीर क्लिक करने के लिए कहें।';

  @override
  String get eyeScanInstructionFive =>
      'एक आंख को अपने हाथ से ढ़क लें और तस्वीर लेते समय दूसरी आंख के साथ ठीक सीधे देखें।';

  @override
  String get eyeScanInstructionSix =>
      'तस्वीर लेने से पहले पैनल के अंदर आंख को बीचों बीच करें।';

  @override
  String get eyeScanInstructionSeven =>
      'फ्लैश बंद होने तक और \'बीप\' ध्वनि से फ़ोटो समाप्त होने तक आंखें खुली रखें।';

  @override
  String get eyeAssessmentNote =>
      'ध्यान दें: यहां दिखाए गए चित्र केवल संकेत के लिए हैं। हो सकता है कि वे वास्तविक जीवन में वैसे ही न दिखें।';
  ...
  String get eyeCaptureCompletionDialogBody =>
      'आपने परीक्षण पूरा किया है। कृपया नीचे दिए गए बटन पर क्लिक करके परिणाम देखने के लिए।';
  ...
  String get eyeCaptureTriageSavedLocally =>
      'ट्राइएज स्थानीय रूप से सहेजा गया है';
  ...
  String get assessmentResultPageMoreDetailsText =>
      'अधिक जानकारी के लिए निकटतम दृष्टि केंद्र पर जाएं। हमारे दृष्टि प्राविधिक से बात करने के लिए टोल-फ्री नंबर पर कॉल करें।';
  ...
  String get homeTriageCardDescription =>
      'आंखों की समस्याओं को रोकने के लिए समय पर जांच करवाएं।';
  ...
  String get homeHelplineCardDescrition =>
      'अचानक दृष्टि के हानि के मामले में, इस आपातकालीन हेल्पलाइन पर कॉल करें';
  ...
  String get inviteCardDescription =>
      '5 दोस्तों और परिवार के सदस्यों को आमंत्रित करें ताकि उनकी आंखों की मूल्यांकन किया जा सके और भविष्य में आंख संबंधी समस्याओं को रोक सकें।';
  ...
  String get visualAcuityTestDistanceInstruction =>
      'कैमरे को आंख से 40 सेमी दूर रखें।';
  ...
  String get triageUpdatedSuccessfully =>
      'ट्राइएज सफलतापूर्वक अपडेट किया गया.\r\n';
  ...
  String get privacyPolicyPurposeOfProcessingSubTitle =>
      'हम आपके द्वारा प्रदान किए गए व्यक्तिगत डेटा को निम्नलिखित उद्देश्यों के लिए संसाधित करते हैं:';

  @override
  String get visualAcuityTestDistanceInstructionTooClose =>
      'आप कैमरे के बहुत करीब हैं, कैमरे को आंख से 40 सेमी दूर रखें।';

  @override
  String get visualAcuityTestDistanceInstructionTooFar =>
      'आप कैमरे से बहुत दूर हैं, कैमरे को आंख से 40 सेमी दूर रखें।';
  ...
  String get eyeBoxText =>
      'कृपया छवि को तब तक समायोजित और स्थिति में रखें जब तक आंखों के चारों ओर हरे रंग के बक्से दिखाई न दें। आंख को पास ले जाएं और सुनिश्चित करें कि बॉक्स का 40% हिस्सा आंख से ढका हो।';
  ...
  String get smsContent =>
      'अरे! मैं अपनी आँखों की देखभाल करने के लिए साइटकनेक्ट ऐप का उपयोग कर रहा हूँ, और आपको भी करना चाहिए! अपनी आँखों का मूल्यांकन करें और साइटकनेक्ट ऐप के साथ समय पर उपचार प्राप्त करें। यह एक अनोखा ऐप है जो आपके हाथ में निवारक आईकेयर लाता है। इसे अभी प्राप्त करेंः https://healthconnecttech.org/install';

  @override
  String get emailSubject =>
      'साइटकनेक्ट ऐप के साथ अपनी आँखों के स्वास्थ्य को प्राथमिकता दें!';
  ...
  String get chatBotDefaultQuerySuggestions =>
      'शुरू करें नेत्र मूल्यांकन। आम नेत्र समस्याएं। बेहतर दृष्टि के लिए सुझाव';
  ...
  String get triageExitConfirmation =>
      'क्या आप परीक्षा से बाहर होना चाहते हैं?';
  ...
  String get triageEyeScanUpdatedSuccessfully =>
      'नेत्र स्कैन सफलतापूर्वक अद्यतन किया गया';

  @override
  String get triageErrorEyeScanNotUpdated =>
      'नेत्र स्कैन अद्यतन नहीं किया गया है!';
  ...
  String get vaSwipeGestureError =>
      'अमान्य स्वाइप इशारा। कृपया फिर से प्रयास करें।';
  ...
  String get vaDistanceToFaceInstruction =>
      'कृपया सुनिश्चित करें कि कैमरा आपके चेहरे से 40 सेमी दूर है।';
  ...
  String get optoLogoutError =>
      'क्षमा करें, हमें मोबाइल ऐप में लॉगआउट त्रुटि का सामना करना पड़ा।';
  ...
  String get optoImproveApp =>
      'हम चाहेंगे कि आपकी प्रतिक्रिया से हमारे आवेदन में सुधार हो।';
  ...
  String get patientEarlyConsultationRecommended =>
      'प्रारंभिक परामर्श की सिफारिश की गई';
  ...
  String get patientSkipAndProceedToScan =>
      'स्किप करें और स्कैन के लिए आगे बढ़ें';
  ...
  String get vgShouldNotContainSpecialCharacter =>
      'इसमें कोई विशेष वर्ण नहीं होना चाहिए।';
  ...
  String get vgEyeAssessmentDescription =>
      'कुछ चरणों में अपनी, अपने दोस्तों और परिवार के सदस्यों की आँखों की समस्याओं का मूल्यांकन करवाएँ। आपको अपनी आँखों की समस्याओं से संबंधित लक्षणों को समझने के लिए प्रश्नों का एक समूह पूछा जाएगा और उसके बाद दृश्य परीक्षण किए जाएंगे।';
  ...
  String get secureRestrictedAccess =>
      'सुरक्षा कारणों से, इस ऐप तक पहुंच जेलब्रोकन उपकरणों पर प्रतिबंधित है।';
  ...
  String get sharedErrorPageIssues =>
      'हम कुछ समस्याओं का सामना कर रहे हैं। कृपया बाद में फिर से प्रयास करें।';
  ...
  String get emptyPatientsInfo =>
      'रोगियों को उनका विवरण देखने के लिए खोजना शुरू करें।';
  ...
  String get vtCallLogEmpty =>
      'कॉल लॉग खाली है.. अभी तक कोई कॉल नहीं किया गया है!!';
  ...
  String get vtIvrCallNotAvailable =>
      'आई. वी. आर. कॉल उपलब्ध नहीं है. फिर से कोशिश करें!!';
  ...
  String get vtNotRegistered =>
      'आप सिस्टम में पंजीकृत नहीं हैं। कृपया एक मिस्ड कॉल दें';
