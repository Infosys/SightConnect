...
class AppLocalizationsTe extends AppLocalizations {
  ...
  @override
  String get privacyPolicyPurposeOfProcessingTitle => 'ప్రాసెసింగ్ యొక్క ఉద్దేశ్యం: మీరు అందించిన వ్యక్తిగత డేటాను ఈ క్రింది ప్రయోజనాల కోసం మేము ప్రాసెస్ చేస్తాము:';
