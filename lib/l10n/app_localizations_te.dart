...
class AppLocalizationsTe extends AppLocalizations {
  ...
  String patientHasAnAppointment(String patient) {
    return '$patientకి అపాయింట్‌మెంట్ ఉంది';
  }

  @override
  String vgEmptyResults(String type) {
    return 'ప్రస్తుతం $typeలు లేవు. "Add $type" పై ట్యాప్ చేయండి';
  }
  ...
  String get questionnaireExitDialog =>
      'ఈ ప్రశ్నలకు సమాధానం ఇవ్వడం మీ కంటి సమస్యలను గుర్తించడంలో సహాయపడుతుంది. మీరు నిజంగా నిష్క్రమించాలనుకుంటున్నారా?';
  ...
  String get visualAcuityDescription =>
      'దృశ్య తీక్షణ పరీక్ష అనేది ఒక నిర్దిష్ట దూరం నుండి ఒక అక్షరం లేదా చిహ్నం యొక్క వివరాలను మీరు ఎంత బాగా చూస్తున్నారో తనిఖీ చేసే కంటి పరీక్ష. ఈ శీఘ్ర పరీక్షను ఇప్పుడే చేయండి!';

  @override
  String get visualAcuityHowToPerform =>
      'దృశ్య తీక్షణత పరీక్షను ఎలా నిర్వహించాలి?';

  @override
  String get visualAcuityViewStepsToPerform =>
      'దృశ్య తీక్షణ పరీక్ష నిర్వహించడానికి దశలను చూడండి';

  @override
  String get visualAcuityCompletionDialog =>
      'పూర్తయింది! రెండు కళ్ళకు దృశ్య తీక్షణ పరీక్ష పూర్తయింది. తరువాత మీరు మీ కంటి ఫోటోలను తీయాలి.';

  @override
  String get visualAcuityExitDialog =>
      'మీ కంటి సమస్య గురించి అర్థం చేసుకోవడానికి దృశ్య తీక్షణత ఒక ముఖ్యమైన పరీక్ష. మీరు నిజంగా నిష్క్రమించాలనుకుంటున్నారా?';
  ...
  String get visualAcuityLeftEyeInstructions =>
      'కనురెప్పను నొక్కకుండా, మీ చేతిని కుడి కన్నుపై ఉంచండి. మీరు కళ్ళజోడు ధరించి ఉంటే, మీ చేతిని కళ్ళజోడు మీద ఉంచండి.';
  ...
  String get visualAcuityRightEyeInstructions =>
      'కనురెప్పను నొక్కకుండా, మీ చేతిని ఎడమ కన్నుపై ఉంచండి. మీరు కళ్ళజోడు ధరించి ఉంటే, మీ చేతిని కళ్ళజోడు మీద ఉంచండి.';
  ...
  String get visualAcuityBothEyeInstructions =>
      'మీ కళ్ళను కప్పుకోకండి మరియు రెండు కళ్ళతో పక్కన కనిపించే చిహ్నాలను చూడండి.';
  ...
  String get overlayDescription =>
      'ప్రతి చిహ్నానికి సంబంధించిన దిశలను మీరు ఎలా అర్థం చేసుకోవాలో ఇక్కడ ఉంది.';
  ...
  String get visualAcuityCarouselTitle =>
      'దృశ్య తీక్షణ పరీక్ష నిర్వహించడానికి దశలు';
  ...
  String get eyeScanDescription =>
      'మీరు దగ్గరగా ఉన్నారు! ఇంకా ఒక పరీక్ష మిగిలి ఉంది. తరువాత మీ కళ్ళ ఫోటోలను తీయండి.';
  ...
  String get eyeScanViewStepsToPerform =>
      'మీ కళ్ళను ఎలా స్కాన్ చేయాలో తెలుసుకోవడానికి దశలను చూడండి.';

  @override
  String get eyeScanExitDialog =>
      'కంటి స్కాన్ మీ కంటి సమస్య గురించి మరింత అర్థం చేసుకోవడానికి సహాయపడుతుంది. మీరు నిజంగా బయటకు వెళ్లాలనుకుంటున్నారా?';
  ...
  String get homeCarousal1Title =>
      '40 సంవత్సరాలు మరియు అంతకంటే ఎక్కువ వయస్సు ఉన్న పెద్దలలో కంటిశుక్లం వ్యాప్తి మరియు దాని అనుబంధ కారకాలు';

  @override
  String get homeCarousal1Description =>
      'కంటిశుక్లం మరియు సంబంధిత కారకాల ప్రాబల్యంపై నమూనా ప్రక్రియ యొక్క క్రమబద్ధమైన ప్రదర్శన';
  ...
  String get privacyPolicyDataTransferDescription =>
      'మీరు అందించిన వ్యక్తిగత డేటా భారతదేశంలోని మా అధీకృత సర్వీస్ ప్రొవైడర్ సర్వర్ మరియు మా అంతర్గత సర్వర్లలో నిల్వ చేయబడుతుంది.';
  ...
  String get privacyPolicyDataSecurityDescription =>
      'LVPEI మీ వ్యక్తిగత డేటాను రక్షించడానికి పరిపాలనా, భౌతిక భద్రత మరియు సాంకేతిక నియంత్రణలతో సహా సహేతుకమైన మరియు తగిన భద్రతా పద్ధతులు మరియు విధానాలను అవలంబిస్తుంది.';
  ...
  String get privacyPolicyDataRetentionDescription =>
      'చట్టపరమైన మరియు వ్యాపార అవసరాల ప్రకారం ఇకపై ఉంచాల్సిన అవసరం లేని వ్యక్తిగత డేటా సురక్షితమైన పద్ధతిలో తీసివేయబడుతాయి.';
  ...
  String get privacyPolicyDataSubjectRightsDescription =>
      'మీ వ్యక్తిగత సమాచారాన్ని యాక్సెస్ చేయడానికి మరియు సరిదిద్దడానికి మీకు ఎప్పుడైనా హక్కు ఉంది. ఏదైనా అభ్యర్థనలు, సమస్యలు, ఆందోళనలు లేదా ప్రశ్నలు ఉంటే మీరు ఇమెయిల్ <> పంపడం ద్వారా ఎల్ వి ప్రసాద్ కార్యాలయాన్ని సంప్రదించవచ్చు.';
  ...
  String get assessmentAndTestsSubtitle =>
      'ఇప్పటివరకు చేసిన మదింపుల యొక్క శీఘ్ర వీక్షణ ఇక్కడ ఉంది.';
  ...
  String get eyeAssessmentSubtitle =>
      'మీ స్నేహితులు, కుటుంబ సభ్యులు మరియు మీ యొక్క కంటి సమస్యలను కొన్ని దశల్లో మూల్యాంకనం చేయండి. మీ కంటి సమస్యలకు సంబంధించిన లక్షణాలను అర్థం చేసుకోవడానికి మిమ్మల్ని కొన్ని ప్రశ్నలు అడగబడతాయి, తరువాత దృశ్య పరీక్షలు చేయబడతాయి.';
  ...
  String get eyeAssessmentBrightnessError =>
      'దయచేసి ప్రకాశాన్ని 80 శాతానికి అమర్చండి';
  ...
  String get visualAcuityTestInstructionOne =>
      'బాగా తేలికపాటి ప్రదేశంలో సౌకర్యవంతంగా కూర్చోండి. మీరు ప్రకాశంలో అకస్మాత్తుగా మార్పును గమనించవచ్ఛు, ఆందోళన చెందకండి, సరైన ఫలితాన్ని అందించడానికి స్క్రీన్ స్వయంచాలక ప్రకాశానికి అమర్చబడి ఉంటుంది.';

  @override
  String get visualAcuityTestInstructionTwo =>
      'మీరు పరికరాన్ని కంటి స్థాయిలో పట్టుకున్నారని నిర్ధారించుకోండి. మీరు అద్దాలు లేదా కాంటాక్ట్ లెన్సులు ధరిస్తే, వాటిని ధరించండి.';

  @override
  String get visualAcuityTestInstructionThree =>
      'మొబైలు స్క్రీన్ నుండి మిమ్మల్ని మీరు 40 సెంటీమీటర్ల దూరంలో ఉంచుకోండి. పరీక్ష స్క్రీన్ పై దూరం చూపబడుతుంది.';

  @override
  String get visualAcuityTestInstructionFour =>
      'మీరు అద్దాలతో పరీక్షిస్తున్నట్లయితే, ఒక కంటిని మాత్రమే పరీక్షించినప్పుడు అద్దాలపై మీ చేతితో ఒక కన్ను మూయండి.';
  ...
  String get eyeAssessmentCompleteSteps =>
      'ఫలితాలను చూడటానికి అన్ని దశలను పూర్తి చేయండి';

  @override
  String get eyeAssessmentToolTip =>
      'దయచేసి ఫ్లాష్ ఆపివేయబడిందని మరియు ప్రకాశం 80 శాతానికి సెట్ చేయబడిందని నిర్ధారించుకోండి';

  @override
  String get eyeScanInstructionOne =>
      'ఫ్రేమ్పై ముఖం సరిగ్గా ఉంచి కెమెరాను పట్టుకోండి.';

  @override
  String get eyeScanInstructionTwo =>
      'మీ ఫోన్ వెనుక కెమెరాను ఉపయోగించి కళ్ళ చిత్రాన్ని తీయండి.';

  @override
  String get eyeScanInstructionThree =>
      'ఫ్లాష్ ఆన్ చేసి బాగా వెలుతురు వున్న ప్రదేశంలో ఉండేలా చూసుకోండి.';

  @override
  String get eyeScanInstructionFour =>
      'మెరుగైన సంగ్రహణం మరియు స్పష్టత కోసం, చిత్రాన్ని క్లిక్ చేయడానికి మరొకరి సహాయం తీసుకోండి.';

  @override
  String get eyeScanInstructionFive =>
      'చిత్రాన్ని తీసేటప్పుడు ఒక కన్ను మీ చేతితో మూసి, మరొక కన్ను నేరుగా ముందుకు చూడండి.';

  @override
  String get eyeScanInstructionSix =>
      'చిత్రాన్ని ప్రారంభించే ముందు ప్యానెల్ లోపల కన్ను కేంద్రీకరించండి.';

  @override
  String get eyeScanInstructionSeven =>
      'ఫ్లాష్ ఆరిపోయే వరకు కళ్ళు తెరిచి ఉంచండి, \'బీప్\' ధ్వని ఫోటో ముగింపును సూచిస్తుంది.';

  @override
  String get eyeAssessmentNote =>
      'గమనిక: ఇక్కడ చూపిన చిత్రాలు సూచన కోసం మాత్రమే. నిజ జీవితంలో ఇదే విధంగా కనిపించకపోవచ్చు.';
  ...
  String get eyeCaptureCompletionDialogBody =>
      'మీరు పరీక్షను పూర్తి చేసారు. ఫలితాన్ని చూడటానికి దయచేసి దిగువ బటన్పై క్లిక్ చేయండి.';
  ...
  String get assessmentResultPageMoreDetailsText =>
      'మరిన్ని వివరాల కోసం సమీప దృష్టి కేంద్రాన్ని సందర్శించండి. మా దృష్టి సాంకేతిక నిపుణుడితో మాట్లాడటానికి టోల్ ఫ్రీ నంబర్కు కాల్ చేయండి.';
  ...
  String get homeTriageCardDescription =>
      'కంటి సమస్యలను నివారించడానికి వాటిని సకాలంలో పరీక్షించండి.';
  ...
  String get homeHelplineCardDescrition =>
      'అకస్మాతీకరణ దృష్టి నష్టం కాలమోలకంగా, ఈ అత్యావసర హెల్ప్‌లైన్‌కు కాల్ చేయండి';
  ...
  String get inviteCardDescription =>
      '5 స్నేహితులను మరియు కుటుంబ సభ్యులను ఆమంత్రించండి, భవిష్యత్తులో వారి కంటి సమస్యలను తడుముగా తగ్గించడానికి అవకాశం కల్పంచండి.';
  ...
  String get visualAcuityTestDistanceInstruction =>
      'కెమెరాను కంటికి 40 సెం.మీ దూరంలో ఉంచండి.';
  ...
  String get privacyPolicyPurposeOfProcessingSubTitle =>
      'కింది ప్రయోజనాల కోసం మీరు అందించిన వ్యక్తిగత డేటాను మేము ప్రాసెస్ చేస్తాము:';

  @override
  String get visualAcuityTestDistanceInstructionTooClose =>
      'మీరు కెమెరాకు చాలా దగ్గరగా ఉన్నారు, కెమెరాను కంటికి 40 సెం.మీ దూరంలో ఉంచండి.';

  @override
  String get visualAcuityTestDistanceInstructionTooFar =>
      'మీరు కెమెరాకు చాలా దూరంగా ఉన్నారు, కెమెరాను కంటికి 40 సెం.మీ దూరంలో ఉంచండి.';
  ...
  String get eyeBoxText =>
      'కళ్ళ చుట్టూ ఆకుపచ్చ పెట్టెలు కనిపించే వరకు దయచేసి చిత్రాన్ని సర్దుబాటు చేసి ఉంచండి. కంటికి దగ్గరగా వెళ్లి, పెట్టెలో 40 శాతం కంటితో కప్పబడి ఉండేలా చూసుకోండి.';
  ...
  String get emailSubject =>
      'సైట్కనెక్ట్ యాప్ ద్వారా మీ కంటి ఆరోగ్యానికి ప్రాధాన్యత ఇవ్వండి!';
  ...
  String get chatBotDefaultQuerySuggestions =>
      'కంటి అంచనా ప్రారంభించండి | సాధారణ కంటి సమస్యలు | మెరుగైన కంటి చూపు కోసం చిట్కాలు';
  ...
  String get loginEnterValidMobileNumber =>
      'దయచేసి పనిచేసే మొబైల్ నంబర్‌ను నమోదు చేయండి';
  ...
  String get triageExitConfirmation =>
      'మీరు పరీక్షను నిష్క్రమించాలనుకుంటున్నారా?';
  ...
  String get triageReportInstructions =>
      'మీరు కళ్ళ సంబంధిత సమస్యలు ఉన్న వ్యక్తిగా, మీ సమస్యలను స్వయం ప్రకటించి ఇక్కడ సముచిత మార్గదర్శనను పొందవచ్చు. మీ స్నేహితులు లేదా కుటుంబ సభ్యుల కళ్ళ సమస్యలను కూడా ఇక్కడ పేర్కొని సముచిత మార్గదర్శనను పొందవచ్చు.';
  ...
  String get triageEyeScanUpdatedSuccessfully =>
      'కళ్ళ స్కాన్ విజయవంతంగా అప్డేట్ చేయబడింది';
  ...
  String get vaSwipeGestureError =>
      'తప్పు తిరగడం చేస్తున్నారు. మళ్ళీ ప్రయత్నించండి.';
  ...
  String get vaDistanceToFaceInstruction =>
      'కెమెరా మీ ముఖం నుండి 40cm దూరంగా ఉండాలని నిర్ధారించండి';
  ...
  String get optoLogoutError =>
      'క్షమించండి, మొబైల్ అప్లికేషన్లో లాగౌట్ లోపం ఏర్పడింది.';
  ...
  String get optoImproveApp =>
      'మా అప్లికేషన్ను మెరుగుపర్చడానికి మేము మీ అభిప్రాయాన్ని కోరుకుంటున్నాము';
  ...
  String get optoCheckInternet =>
      'దయచేసి మీ ఇంటర్నెట్ కనెక్షన్ను తనిఖీ చేసి మళ్ళీ ప్రయత్నించండి';
  ...
  String get patientEarlyConsultationRecommended =>
      'త్వరిత సంప్రదింపు సిఫారసు చేయబడింది';
  ...
  String get vgUploadingImageAddingEvent =>
      'చిత్రాన్ని అప్లోడ్ చేసి ఈవెంట్ జోడించండి';
  ...
  String get vgEyeAssessmentDescription =>
      'మీరు, మీ స్నేహితులు, కుటుంబ సభ్యుల కన్ను సమస్యలను కొన్ని దశలలో మూల్యాంకన చేయండి. మీ కన్ను సమస్యలకు సంబంధించిన లక్షణాలను అర్థం చేసేందుకు మీకు కొన్ని ప్రశ్నలు అడిగబడతాయి, తరువాత దృశ్య పరీక్షలు జరుగుతాయి.';
  ...
  String get vtAssessmentClosedSuccessfully =>
      'మూల్యాంకనం విజయవంతంగా మూసివేయబడింది';
  ...
  String get secureRestrictedAccess =>
      'భద్రతా కారణాల వల్ల, జెయిల్బ్రేక్ పరికరాల మీద ఈ అప్లికేషన్ యొక్క ప్రాప్యతను నియంత్రించాము.';
  ...
  String get sharedErrorPageIssues =>
      'మేము కొన్ని సమస్యలను ఎదుర్కొంటున్నాము. దయచేసి తరువాత మళ్ళీ ప్రయత్నించండి.';
  ...
  String get emptyPatientsInfo =>
      'రోగుల వివరాలను వీక్షించడానికి వారి కోసం వెతకడం ప్రారంభించండి ..';
  ...
  String get vtIvrCallNotAvailable =>
      'IVR కాల్ అందుబాటులో లేదు.. మళ్లీ ప్రయత్నించండి!!';
  ...
  String get vtNotRegistered =>
      'మీరు వ్యవస్థలో నమోదు చేయబడలేదు. దయచేసి ఒక మిస్డ్ కాల్ ఇవ్వండి';
  ...
  String get vgAddPhotoInstruction =>
      'ఈవెంట్ యొక్క ఫోటోను జోడించండి ఇది థంబ్నేల్ గా చూపిస్తుంది';
  ...
  String get vgNoPatientRegistered =>
      'పేరుతో రోగి నమోదు కాలేదు. రోగిని నమోదు చేయడానికి క్లిక్ చేయండి.';
  ...
  String get vgSearchPatientByPhoneNumber =>
      'ఫోన్ నంబర్ ద్వారా రోగిని శోధించండి';
  ...
  String get vgTeamMateDeletedSuccessfully =>
      'టీమ్ మేట్ విజయవంతంగా తొలగించబడింది';
  ...
  String get vgErrorFetchingTeammatesDetails =>
      'టీమ్ మేట్స్ వివరాలను పొందడంలో లోపం ఉంది';
  ...
  String get vgEndTimeGreaterThanStartTime =>
      'ముగింపు సమయం ప్రారంభ సమయం కంటే ఎక్కువ ఉండాలి';

  @override
  String get vgNoPatientsPresent =>
      'ప్రస్తుతం రోగులు లేరు. "రోగిని జోడించండి" పై నొక్కండి';
}
