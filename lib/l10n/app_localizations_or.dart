...
class AppLocalizationsOr extends AppLocalizations {
  ...
  String get visualAcuityDescription =>
      'ଭିଜୁଆଲ୍ ଆକ୍ଯ଼ୁଇଟି ଟେଷ୍ଟ ହେଉଛି ଏକ ଚକ୍ଷୁ ପରୀକ୍ଷା ଯାହା ଯାଞ୍ଚ କରେ ଯେ ଆପଣ ଏକ ନିର୍ଦ୍ଦିଷ୍ଟ ଦୂରତାରୁ ଏକ ଅକ୍ଷର କିମ୍ବା ଚିହ୍ନର ବିବରଣୀ କେତେ ଭଲ ଦେଖନ୍ତି | ବର୍ତ୍ତମାନ ଏହି  ପରୀକ୍ଷା ଶୀଘ୍ର କରନ୍ତୁ!';
  ...
  String get visualAcuityExitDialog =>
      'ଆପଣଙ୍କ ଚକ୍ଷୁ ସମସ୍ଯ଼ା ବିଷଯ଼ରେ ବୁଝିବା ପାଇଁ ଭିଜୁଆଲ୍ ଆକ୍ଯ଼ୁଇଟି ଏକ ଗୁରୁତ୍ୱପୂର୍ଣ୍ଣ ପରୀକ୍ଷା। ଆପଣ ପ୍ରକୃତରେ ବାହାରକୁ ଯିବାକୁ ଚାହୁଁଛନ୍ତି କି?';
  ...
  String get visualAcuityBothEyeInstructions =>
      'ଆପଣଙ୍କର କୌଣସି ଆଖିକୁ ଢାଂକନ୍ତୁ  ନାହିଁ ଏବଂ ଉଭଯ଼ ଆଖିରେ ପାର୍ଶ୍ୱରେ ଦେଖାଯାଉଥିବା ପ୍ରତୀକଗୁଡ଼ିକୁ ଦେଖନ୍ତୁ |';
  ...
  String get overlayDescription =>
      'ଏଠାରେ ଆପଣ ପ୍ରତ୍ଯ଼େକ ପ୍ରତୀକର ଦିଗକୁ ବୁଝିପାରିବେ।';
  ...
  String get homeCarousal3Title =>
      'ଆଖି ସମସ୍ଯ଼ା। ଏମିତି ଅନେକ ଅଛି ଯାହାକୁ ଆପଣ ଦେଖିପାରିବେ ନାହିଁ।';

  @override
  String get homeCarousal3Description =>
      'କିନ୍ତୁ ଜଣେ ଦୃଷ୍ଟି ଯତ୍ନ ବିଶେଷଜ୍ଞ କରିପାରିବେ| ପରେ ଜଟିଳତାକୁ ଏଡାଇବା ପାଇଁ ଆଖି ସମସ୍ୟାକୁ ଚିହ୍ନଟ କର ଏବଂ ସଠିକ ସମୟରେ ଚିକିତ୍ସା କର |';
  ...
  String get aboutUsConclusion =>
      'ଆମର ବ୍ୟବହାରକାରୀ ସମୁଦାଯ଼କୁ ଉନ୍ନତ ସେବା ଯୋଗାଇବା ପାଇଁ ଅଗ୍ରଣୀ ଚକ୍ଷୁ ଯତ୍ନ ପେସାଦାରଙ୍କ ସହାଯ଼ତାରେ ଏହି ଆପ୍ ବିକଶିତ ହୋଇଛି। ଏକ ଉଜ୍ଜ୍ୱଳ, ସୁସ୍ଥ ବିଶ୍ୱ ସୃଷ୍ଟି କରିବା ପାଇଁ ଆମର ମିଶନରେ ଯୋଗ ଦିଅନ୍ତୁ। ଆଜି ସାଇଟ୍କନେକ୍ଟ ଆପ୍ ଡାଉନଲୋଡ୍ ଏବଂ ସେୟାର  କରନ୍ତୁ!';

  @override
  String get privacyPolicyDescription =>
      'ଏଲ୍. ଭି. ପ୍ରସାଦ ଆଇ. ଇନଷ୍ଟିଚ୍ଯ଼ୁଟ, ଏହାର ସହାଯ଼କ ସଂସ୍ଥା, ସହଯୋଗୀ ଏବଂ ଅନୁବନ୍ଧିତ କମ୍ପାନୀଗୁଡ଼ିକ (ସାମୂହିକ ଭାବେ "ଏଲ୍. ଭି. ପି. ଇ. ଆଇ"., "ଆମକୁ", "ଆମେ") ଆପଣଙ୍କ ଅଧିକାର କ୍ଷେତ୍ରର ଆଇନ ଅନୁଯାଯ଼ୀ ଆପଣଙ୍କ ବ୍ୟକ୍ତିଗତ ତଥ୍ୟ ପ୍ରକ୍ରିଯ଼ାକରଣ କରିବା ପାଇଁ ପ୍ରତିଶୃତିବଦ୍ଧ। ବ୍ୟକ୍ତିଗତ ତଥ୍ୟ ପ୍ରକ୍ରିଯ଼ାକରଣ ବିଷଯ଼ରେ ଆମେ ଆପଣଙ୍କୁ ନିମ୍ନଲିଖିତ ସୂଚନା ସୂଚିତ କରୁଛୁ।';

  @override
  String get privacyPolicyPersonalDataTitle =>
      'ବ୍ଯ଼କ୍ତିଗତ ତଥ୍ଯ଼ ଉପାଦାନଗୁଡିକ ସଂଗୃହୀତ/ପ୍ରକ୍ରିଯ଼ାକୃତ :';
  ...
  String get privacyPolicyDataRecipientsTitle =>
      'ତଥ୍ଯ଼ ପ୍ରାପ୍ତକର୍ତ୍ତା/ଉପଲବ୍ଧକର୍ତ୍ତା';

  @override
  String get privacyPolicyDataRecipientsDescription =>
      'ଆପଣଙ୍କ ଦ୍ୱାରା ସେଯ଼ାର କରାଯାଇଥିବା ବ୍ୟକ୍ତିଗତ  ତଥ୍ୟ  (ସମ୍ବେଦନଶୀଳ ବ୍ୟକ୍ତିଗତ ତଥ୍ଯ଼ ସମେତ) ଡାକ୍ତର/ଚକ୍ଷୁ ବିଶେଷଜ୍ଞ, ଭିଜନ ଟେକ୍ନିସିଆନ, ଭିଜନ ଗାର୍ଡିଆନ, ଏଲଭିପିଇଆଇର ପ୍ରତିନିଧି, ଆଭ୍ୟନ୍ତରିଣ/ବାହ୍ୟ ଅଡିଟର, ସରକାରୀ କର୍ତ୍ତୃପକ୍ଷ , ଆମର ପ୍ରାଧିକୃତ ସେବା ପ୍ରଦାନକାରୀ ଇନଫୋସିସ ଭଳି ପ୍ରାଧିକୃତ ଏଲଭିପିଇଆଇ କର୍ମଚାରୀଙ୍କ ପାଇଁ ଉପଲବ୍ଧ ହେବ।';
  ...
  String get privacyPolicyDataRetentionDescription =>
      'ବ୍ଯ଼କ୍ତିଗତ ତଥ୍ଯ଼ ଯାହା ଆଇନଗତ ଏବଂ ବ୍ଯ଼ବସାଯ଼ିକ ଆବଶ୍ଯ଼କତା ଅନୁଯାଯ଼ୀ ଆଉ ରଖିବା ଆବଶ୍ଯ଼କ ନାହିଁ, ସେଗୁଡିକ  ଏକ ସୁରକ୍ଷିତ ଢଙ୍ଗରେ ନିଷ୍କ୍ରିୟ କରାଯିବ।';
  ...
  String get privacyPolicyDataSubjectRightsDescription =>
      'ଯେକୌଣସି ସମଯ଼ରେ ଆପଣ ଆପଣଙ୍କର ବ୍ୟକ୍ତିଗତ ସୂଚନାକୁ ପ୍ରବେଶ ଏବଂ ସଂଶୋଧନ କରିବାର ଅଧିକାର ରହିଛି। କୌଣସି ଅନୁରୋଧ, ସମସ୍ୟା  , ଚିନ୍ତା କିମ୍ବା ପ୍ରଶ୍ନ କ୍ଷେତ୍ରରେ ଆପଣ <ଏଲ୍.ଭି.ପି.ଇ.ଆଇ  ସାଧାରଣ ମେଲ ଆଇଡି ପ୍ରଦାନ କରିବ ଡି. ଏସ୍. ଆର୍. ପାଇଁ > କୁ  ଇମେଲ ପଠାଇ ଏଲ୍. ଭି. ପ୍ରସାଦ କାର୍ଯ୍ୟାଳୟ ସହିତ ଯୋଗାଯୋଗ କରିପାରିବେ । ';
  ...
  String get eyeAssessmentBrightnessError =>
      'ଦଯ଼ାକରି ହସ୍ତକୃତ ଭାବେ ଉଜ୍ଜ୍ୱଳତାକୁ 80 ପ୍ରତିଶତରେ ସେଟ କରନ୍ତୁ।';
  ...
  String get visualAcuityTestInstructionOne =>
      'ଏକ ଭଲ ହାଲୁକା ସ୍ଥାନରେ ଆରାମରେ ବସନ୍ତୁ। ଆପଣ ହଠାତ୍ ଉଜ୍ଜ୍ୱଳତାରେ ପରିବର୍ତ୍ତନ ଅନୁଭବ କରିପାରନ୍ତି, ଚିନ୍ତା କରନ୍ତୁ ନାହିଁ , ସର୍ବୋତ୍ତମ ଫଳାଫଳ ପ୍ରଦାନ କରିବା ପାଇଁ ସ୍କ୍ରିନ୍ ସ୍ୱଯ଼ଂଚାଳିତ ଉଜ୍ଜ୍ୱଳତାକୁ ସେଟ୍ ହୋଇଛି |';
  ...
  String get eyeAssessmentStepOne =>
      'ପର୍ଯ୍ଯ଼ାଯ଼ 1-ଚକ୍ଷୁ ମୂଲ୍ଯ଼ାଙ୍କନ ପ୍ରଶ୍ନଗୁଡିକ';

  @override
  String get eyeAssessmentStepTwo =>
      'ପର୍ଯ୍ଯ଼ାଯ଼ 2-ଚକ୍ଷୁ ମୂଲ୍ଯ଼ାଙ୍କନ ପ୍ରଶ୍ନଗୁଡିକ';

  @override
  String get eyeAssessmentStepThree =>
      'ପର୍ଯ୍ଯ଼ାଯ଼ 3-ଚକ୍ଷୁ ମୂଲ୍ଯ଼ାଙ୍କନ ପ୍ରଶ୍ନଗୁଡିକ';
  ...
  String get eyeAssessmentCompleteSteps =>
      'ଫଳାଫଳ ଦେଖିବା ପାଇଁ ସମସ୍ତ ପର୍ଯ୍ଯ଼ାଯ଼ ପୂରଣ କରନ୍ତୁ';
  ...
  String get eyeScanInstructionFive =>
      'ଫଟୋ ଉଠାଇବା ସମଯ଼ରେ ଗୋଟିଏ ଆଖିକୁ ହାତରେ ଢାଙ୍କି ଅନ୍ଯ଼ ଆଖିରେ ସିଧା ଆଗକୁ ଦେଖନ୍ତୁ।';
  ...
  String get eyeAssessmentNote =>
      'ଟିପ୍ପଣୀ: ଏଠାରେ ଦେଖାଯାଇଥିବା ପ୍ରତିଛବିଗୁଡ଼ିକ କେବଳ ସୂଚାଇବା ପାଇଁ | ବାସ୍ତବ ଜୀବନରେ ସେଗୁଡ଼ିକ ସମାନ ଭାବରେ ଦେଖାଯାଇନପାରେ |';
  ...
  String get homeTriageCardDescription =>
      'ଆଖି ସମସ୍ୟାକୁ ରୋକିବା ପାଇଁ ଠିକ୍ ସମୟରେ ଯାଞ୍ଚ କରନ୍ତୁ |';
  ...
  String get homeHelplineCardDescrition =>
      'ହଠାତ୍ ଦୃଷ୍ଟି ଶକ୍ତି ହରାଇଲେ, ଏହି ଜରୁରୀକାଳୀନ ହେଲ୍ପଲାଇନକୁ ଡାକନ୍ତୁ |';
  ...
  String get visualAcuityTestDistanceInstruction =>
      'କ୍ଯ଼ାମେରାଟିକୁ ଆଖିଠାରୁ 40 ସେ. ମି. ଦୂରରେ ରଖନ୍ତୁ।';
  ...
  String get privacyPolicyPurposeOfProcessingSubTitle =>
      'ଆମେ ନିମ୍ନୋକ୍ତ ଉଦ୍ଦେଶ୍ଯ଼ ପାଇଁ ଆପଣଙ୍କ ଦ୍ୱାରା ପ୍ରଦାନ କରାଯାଇଥିବା ବ୍ଯ଼କ୍ତିଗତ ତଥ୍ଯ଼କୁ ପ୍ରକ୍ରିଯ଼ାକରଣ କରୁ, ଯେପରିକିଃ';

  @override
  String get visualAcuityTestDistanceInstructionTooClose =>
      'ଆପଣ କ୍ଯ଼ାମେରାର ଅତି ନିକଟରେ ଅଛନ୍ତି, କ୍ଯ଼ାମେରାକୁ ଆଖିଠାରୁ 40 ସେ. ମି. ଦୂରରେ ରଖନ୍ତୁ।';

  @override
  String get visualAcuityTestDistanceInstructionTooFar =>
      'ଆପଣ କ୍ଯ଼ାମେରାରୁ ବହୁତ ଦୂରରେ ଅଛନ୍ତି, କ୍ଯ଼ାମେରାକୁ ଆଖିଠାରୁ 40 ସେ. ମି. ଦୂରରେ ରଖନ୍ତୁ।';
  ...
  String get eyeBoxText =>
      'ଆଖି ଚାରିପାଖରେ ସବୁଜ ବାକ୍ସ ଦୃଶ୍ଯ଼ମାନ ହେବା ପର୍ଯ୍ଯ଼ନ୍ତ ଦଯ଼ାକରି ପ୍ରତିଛବିକୁ ଆଡଜଷ୍ଟ ଏବଂ ପୋଜିସନ୍ କରନ୍ତୁ | ଆଖିକୁ ନିକଟତର କରନ୍ତୁ ଏବଂ ସୁନିଶ୍ଚିତ କରନ୍ତୁ ଯେ ବାକ୍ସଟିର 40 ପ୍ରତିଶତ ଆଖି ଦ୍ୱାରା ଆଚ୍ଛାଦିତ ହୋଇଛି।';
  ...
  String get chatBotDefaultQuerySuggestions =>
      'ଆଖି ମୂଲ୍ଯ଼ାଙ୍କନ ଆରମ୍ଭ କରନ୍ତୁ | ସାଧାରଣ ଆଖି ସମସ୍ଯ଼ା | ଉତ୍ତମ ଦୃଷ୍ଟିଶକ୍ତି ପାଇଁ ଟିପ୍ସ';

  @override
  String get chatBotWelcomeMessage =>
      'ନମସ୍କାର, ମୁଁ ଆଜି ଆପଣଙ୍କୁ କିପରି ସାହାଯ୍ଯ଼ କରିପାରିବି?';
