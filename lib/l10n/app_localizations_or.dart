...
class AppLocalizationsOr extends AppLocalizations {
  ...
  @override
  String get visualAcuityDescription => 'ଏକ ଭିଜୁଆଲ୍ ଆକ୍ଯ଼ୁଇଟି ଟେଷ୍ଟ ହେଉଛି ଏକ ଚକ୍ଷୁ ପରୀକ୍ଷା ଯାହା ଯାଞ୍ଚ କରେ ଯେ ଆପଣ ଏକ ନିର୍ଦ୍ଦିଷ୍ଟ ଦୂରତାରୁ ଏକ ଅକ୍ଷର କିମ୍ବା ଚିହ୍ନର ବିବରଣୀ କେତେ ଭଲ ଦେଖନ୍ତି | ବର୍ତ୍ତମାନ ଏହି ଶୀଘ୍ର ପରୀକ୍ଷା କରନ୍ତୁ!';
  ...
  @override
  String get visualAcuityExitDialog => 'ଆପଣଙ୍କ ଚକ୍ଷୁ ସମସ୍ଯ଼ା ବିଷଯ଼ରେ ବୁଝିବା ପାଇଁ ଦୃଷ୍ଟି ତୀକ୍ଷ୍ଣତା ଏକ ଗୁରୁତ୍ୱପୂର୍ଣ୍ଣ ପରୀକ୍ଷା। ଆପଣ ପ୍ରକୃତରେ ବାହାରକୁ ଯିବାକୁ ଚାହୁଁଛନ୍ତି କି?';
  ...
  @override
  String get visualAcuityBothEyeInstructions => 'ଆପଣଙ୍କର କୌଣସି ଆଖିକୁ ଆଚ୍ଛାଦନ କରନ୍ତୁ ନାହିଁ ଏବଂ ଉଭଯ଼ ଆଖିରେ ପାର୍ଶ୍ୱରେ ଦେଖାଯାଉଥିବା ପ୍ରତୀକଗୁଡ଼ିକୁ ଦେଖନ୍ତୁ |';

  @override
  String get overlayHeaderDirection => 'ଦିଗ ନିର୍ଦ୍ଧାରଣ';

  @override
  String get overlayDescription => 'ଏଠାରେ ଆପଣ ପ୍ରତ୍ଯ଼େକ ପ୍ରତୀକର ଦିଗକୁ କିପରି ବୁଝନ୍ତି।';
  ...
  @override
  String get homeCarousal2Description => 'ପରୀକ୍ଷା ପାଇଁ 7ଟି ଚକ୍ଷୁ ସମସ୍ଯ଼ାଃ ଆଖି ଲାଲ ହେବା, ଆଖିରୁ ପାଣି ବାହାରିବା, ଆଖିରେ ଧଳା ଦାଗ';

  @override
  String get homeCarousal3Title => 'ଆଖି ସମସ୍ଯ଼ା। ଏମିତି ଅନେକ ଜିନିଷ ଅଛି ଯାହାକୁ ଆପଣ ଦେଖିପାରିବେ ନାହିଁ।';

  @override
  String get homeCarousal3Description => 'କିନ୍ତୁ ଜଣେ ଦୃଷ୍ଟି ଯତ୍ନ ବିଶେଷଜ୍ଞ ଆଖି ସମସ୍ଯ଼ା ଚିହ୍ନଟ କରିପାରିବେ ଏବଂ ପରେ ଜଟିଳତାକୁ ଏଡ଼ାଇବା ପାଇଁ ଠିକ୍ ସମଯ଼ରେ ଚିକିତ୍ସା କରିପାରିବେ।';
  ...
  @override
  String get aboutUsConclusion => 'ଆମର ବ୍ଯ଼ବହାରକାରୀ ସମୁଦାଯ଼କୁ ଉନ୍ନତ ସେବା ଯୋଗାଇବା ପାଇଁ ଅଗ୍ରଣୀ ଚକ୍ଷୁ ଯତ୍ନ ପେସାଦାରଙ୍କ ସହାଯ଼ତାରେ ଏହି ଆପ୍ ବିକଶିତ ହୋଇଛି। ଏକ ଉଜ୍ଜ୍ୱଳ, ସୁସ୍ଥ ବିଶ୍ୱ ସୃଷ୍ଟି କରିବା ପାଇଁ ଆମର ମିଶନରେ ଯୋଗ ଦିଅନ୍ତୁ। ଆଜି ସାଇଟ୍କନେକ୍ଟ ଆପ୍ ଡାଉନଲୋଡ୍ ଏବଂ ଅଂଶୀଦାର କରନ୍ତୁ!';
  ...
  @override
  String get privacyPolicyPersonalDataTitle => 'ସଂଗୃହୀତ/ପ୍ରକ୍ରିଯ଼ାକୃତ ବ୍ଯ଼କ୍ତିଗତ ତଥ୍ଯ଼ ଉପାଦାନଃ';
  ...
  @override
  String get privacyPolicyPurposeOfProcessingTitle => 'ପ୍ରକ୍ରିଯ଼ାକରଣର ଉଦ୍ଦେଶ୍ଯ଼ଃ ଆମେ ଆପଣଙ୍କ ଦ୍ୱାରା ପ୍ରଦାନ କରାଯାଇଥିବା ବ୍ଯ଼କ୍ତିଗତ ତଥ୍ଯ଼କୁ ନିମ୍ନୋକ୍ତ ଉଦ୍ଦେଶ୍ଯ଼ରେ ପ୍ରକ୍ରିଯ଼ାକରଣ କରୁ, ଯେପରିକିଃ';
  ...
  @override
  String get privacyPolicyDataRecipientsTitle => 'ତଥ୍ଯ଼ ପ୍ରାପ୍ତକର୍ତ୍ତା/ସେମାନଙ୍କ ପାଇଁ ଉପଲବ୍ଧଃ';

  @override
  String get privacyPolicyDataRecipientsDescription => 'ଆପଣଙ୍କ ଦ୍ୱାରା ସେଯ଼ାର କରାଯାଇଥିବା ବ୍ଯ଼କ୍ତିଗତ ତଥ୍ଯ଼ (ସମ୍ବେଦନଶୀଳ ବ୍ଯ଼କ୍ତିଗତ ତଥ୍ଯ଼ ସମେତ) ଡାକ୍ତର/ଚକ୍ଷୁ ବିଶେଷଜ୍ଞ, ଭିଜନ ଟେକ୍ନିସିଆନ, ଭିଜନ ଗାର୍ଡିଆନ, ଏଲଭିପିଇଆଇର ପ୍ରତିନିଧି, ଆଭ୍ଯ଼ନ୍ତରୀଣ/ବାହ୍ଯ଼ ଅଡିଟର, ସରକାରୀ କର୍ତ୍ତୃପକ୍ଷ ଏବଂ ଆମର ପ୍ରାଧିକୃତ ସେବା ପ୍ରଦାନକାରୀ ଇନଫୋସିସ ଭଳି ପ୍ରାଧିକୃତ ଏଲଭିପିଇଆଇ କର୍ମଚାରୀଙ୍କ ପାଇଁ ଉପଲବ୍ଧ ହେବ।';
  ...
  @override
  String get privacyPolicyDataRetentionDescription => 'ବ୍ଯ଼କ୍ତିଗତ ତଥ୍ଯ଼ ଯାହା ଆଇନଗତ ଏବଂ ବ୍ଯ଼ବସାଯ଼ିକ ଆବଶ୍ଯ଼କତା ଅନୁଯାଯ଼ୀ ଆଉ ରଖିବା ଆବଶ୍ଯ଼କ ନାହିଁ, ଏକ ସୁରକ୍ଷିତ ଢଙ୍ଗରେ ସମାଧାନ କରାଯିବ।';

  @override
  String get privacyPolicyDataSubjectRightsTitle => 'ତଥ୍ଯ଼ ବିଷଯ଼ ଅଧିକାରଃ';

  @override
  String get privacyPolicyDataSubjectRightsDescription => 'ଯେକୌଣସି ସମଯ଼ରେ ଆପଣଙ୍କର ବ୍ଯ଼କ୍ତିଗତ ସୂଚନାକୁ ପ୍ରବେଶ ଏବଂ ସଂଶୋଧନ କରିବାର ଅଧିକାର ରହିଛି। କୌଣସି ଅନୁରୋଧ, ସମସ୍ଯ଼ା, ଚିନ୍ତା କିମ୍ବା ପ୍ରଶ୍ନ କ୍ଷେତ୍ରରେ ଆପଣ ଡି. ଏସ୍. ଆର୍.> ପାଇଁ ଜେନେରିକ୍ ମେଲ୍ ଆଇ. ଡି. ପ୍ରଦାନ କରିବା ପାଇଁ <ଏଲ୍. ଭି. ପି. ଇ. ଆଇ. କୁ ଇମେଲ ପଠାଇ ଏଲ୍. ଭି. ପ୍ରସାଦ କାର୍ଯ୍ଯ଼ାଳଯ଼ ସହିତ ଯୋଗାଯୋଗ କରିପାରିବେ।';
  ...
  @override
  String get eyeAssessmentBrightnessError => 'ଦଯ଼ାକରି ସ୍ୱଯ଼ଂକ୍ରିଯ଼ ଭାବେ ଉଜ୍ଜ୍ୱଳତାକୁ 80 ପ୍ରତିଶତରେ ସେଟ କରନ୍ତୁ।';
  ...
  @override
  String get visualAcuityTestInstructionOne => 'ଏକ ଭଲ ହାଲୁକା ସ୍ଥାନରେ ଆରାମରେ ବସନ୍ତୁ। ଆପଣ ହଠାତ୍ ଉଜ୍ଜ୍ୱଳତାରେ ପରିବର୍ତ୍ତନ ଅନୁଭବ କରିପାରନ୍ତି, ଚିନ୍ତା କରନ୍ତୁ ନାହିଁ ଯେ ସର୍ବୋତ୍ତମ ଫଳାଫଳ ପ୍ରଦାନ କରିବା ପାଇଁ ସ୍କ୍ରିନ୍ ସ୍ୱଯ଼ଂଚାଳିତ ଉଜ୍ଜ୍ୱଳତାକୁ ସେଟ୍ ହୋଇଛି |';
  ...
  @override
  String get eyeAssessmentCompleteSteps => 'ଫଳାଫଳ ଦେଖିବା ପାଇଁ ସମସ୍ତ ପଦକ୍ଷେପ ପୂରଣ କରନ୍ତୁ';
  ...
  @override
  String get eyeScanInstructionFive => 'ଫଟୋ ଉଠାଇବା ସମଯ଼ରେ ଗୋଟିଏ ଆଖିକୁ ହାତରେ ଢାଙ୍କି ଅନ୍ଯ଼ ଆଖିକୁ ସିଧା ଆଗକୁ ଦେଖନ୍ତୁ।';
  ...
  @override
  String get eyeAssessmentNote => 'ଟିପନ୍ତୁ: ଏଠାରେ ଦେଖାଯାଇଥିବା ପ୍ରତିଛବିଗୁଡ଼ିକ କେବଳ ସୂଚାଇବା ପାଇଁ | ବାସ୍ତବ ଜୀବନରେ ସେଗୁଡ଼ିକ ସମାନ ଭାବରେ ଦେଖାଯାଇନପାରେ |';
  ...
  @override
  String get homeTriageCardDescription => 'ଚକ୍ଷୁ ପ୍ରସ୍ତୁତ ହେବା ପୂର୍ବରୁ ସମୟରେ ପରୀକ୍ଷା କରନ୍ତୁ ଯାହା ଚକ୍ଷୁ ମୁଖ୍ୟ ବିରୋଧଗ୍ରାସି ରୋକିବା ପାଇଁ ।';

  @override
  String get homeTriageCardTest => 'ଚକ୍ଷୁ ପରୀକ୍ଷା ଶୁରୁ କରନ୍ତୁ';

  @override
  String get homeHelplineCardDescrition => 'ଅସ୍ପଷ୍ଟ ଦୃଷ୍ଟି ହାନିରେ, ଏହା ଆପତ୍ତି ହେଲାଇନରେ ଏହି ଆପାତକାଲୀରେ କଲ୍ କରନ୍ତୁ';
