...
class AppLocalizationsOr extends AppLocalizations {
  ...
  String get questionnaireExitDialog =>
      'ଏହି ପ୍ରଶ୍ନଗୁଡ଼ିକର ଉତ୍ତର ଦେବା ଦ୍ୱାରା ଆପଣଙ୍କ ଚକ୍ଷୁ ସମ୍ବନ୍ଧୀଯ଼ ସମସ୍ଯ଼ା ଚିହ୍ନଟ କରିବାରେ ସାହାଯ୍ଯ଼ ମିଳିବ। ଆପଣ ପ୍ରକୃତରେ ଏଥିରୁ ବାହାରି ଯିବାକୁ ଚାହୁଁଛନ୍ତି କି?';
  ...
  String get visualAcuityDescription =>
      'ଏକ ଭିଜୁଆଲ୍ ଆକ୍ଯ଼ୁଇଟି ଟେଷ୍ଟ ହେଉଛି ଏକ ଚକ୍ଷୁ ପରୀକ୍ଷା ଯାହା ଯାଞ୍ଚ କରେ ଯେ ଆପଣ ଏକ ନିର୍ଦ୍ଦିଷ୍ଟ ଦୂରତାରୁ ଏକ ଅକ୍ଷର କିମ୍ବା ଚିହ୍ନର ବିବରଣୀ କେତେ ଭଲ ଦେଖନ୍ତି | ବର୍ତ୍ତମାନ ଏହି ଶୀଘ୍ର ପରୀକ୍ଷା କରନ୍ତୁ!';

  @override
  String get visualAcuityHowToPerform =>
      'ଭିଜୁଆଲ୍ ଆକ୍ଯ଼ୁଇଟି ପରୀକ୍ଷା କିପରି କରାଯିବ?';

  @override
  String get visualAcuityViewStepsToPerform =>
      'ଭିଜୁଆଲ୍ ଆକ୍ଯ଼ୁଇଟି ଟେଷ୍ଟ କରିବା ପାଇଁ ପଦକ୍ଷେପଗୁଡ଼ିକୁ ଦେଖନ୍ତୁ';

  @override
  String get visualAcuityCompletionDialog =>
      'ସମାପ୍ତ! ଉଭଯ଼ ଆଖି ପାଇଁ ଭିଜୁଆଲ୍ ଆକ୍ଯ଼ୁଇଟି ଟେଷ୍ଟ ସମାପ୍ତ ହୋଇଛି। ଏହା ପରେ ଆପଣଙ୍କୁ ନିଜ ଆଖିର ଫଟୋ ଉଠାଇବାକୁ ପଡ଼ିବ।';

  @override
  String get visualAcuityExitDialog =>
      'ଆପଣଙ୍କ ଚକ୍ଷୁ ସମସ୍ଯ଼ା ବିଷଯ଼ରେ ବୁଝିବା ପାଇଁ ଦୃଷ୍ଟି ତୀକ୍ଷ୍ଣତା ଏକ ଗୁରୁତ୍ୱପୂର୍ଣ୍ଣ ପରୀକ୍ଷା। ଆପଣ ପ୍ରକୃତରେ ବାହାରକୁ ଯିବାକୁ ଚାହୁଁଛନ୍ତି କି?';

  @override
  String get swipeGestureTab => 'ସ୍ୱାଇପ୍ ଅଙ୍ଗଭଙ୍ଗୀ';
  ...
  String get visualAcuityLeftEyeInstructions =>
      'ଆଖିପତା ଉପରେ ଚାପ ନଦେଇ, ଡାହାଣ ଆଖିକୁ ହାତରେ ଢାଙ୍କି ଦିଅନ୍ତୁ। ଯଦି ଆପଣ ଚଷମା ପିନ୍ଧିଛନ୍ତି, ତେବେ ଚଷମା ଉପରେ ହାତ ରଖନ୍ତୁ।';
  ...
  String get visualAcuityRightEyeInstructions =>
      'ଆଖିପତା ଉପରେ ଚାପ ନଦେଇ ବାମ ଆଖିକୁ ହାତରେ ଢାଙ୍କି ଦିଅନ୍ତୁ। ଯଦି ଆପଣ ଚଷମା ପିନ୍ଧିଛନ୍ତି, ତା \'ହେଲେ ଚଷମା ଉପରେ ହାତ ରଖନ୍ତୁ।';
  ...
  String get visualAcuityBothEyeInstructions =>
      'ଆପଣଙ୍କର କୌଣସି ଆଖିକୁ ଆଚ୍ଛାଦନ କରନ୍ତୁ ନାହିଁ ଏବଂ ଉଭଯ଼ ଆଖିରେ ପାର୍ଶ୍ୱରେ ଦେଖାଯାଉଥିବା ପ୍ରତୀକଗୁଡ଼ିକୁ ଦେଖନ୍ତୁ |';

  @override
  String get overlayHeaderDirection => 'ଦିଗ ନିର୍ଦ୍ଧାରଣ';

  @override
  String get overlayDescription =>
      'ଏଠାରେ ଆପଣ ପ୍ରତ୍ଯ଼େକ ପ୍ରତୀକର ଦିଗକୁ କିପରି ବୁଝନ୍ତି।';

  @override
  String get overlaySymbolDirectionText => 'ପ୍ରତୀକ ଦିଗଃ';
  ...
  @override
  String get directionRight => 'ଠିକ୍।';
  ...
  String get visualAcuityCarouselTitle =>
      'ଭିଜୁଆଲ୍ ଆକ୍ଯ଼ୁଇଟି ଟେଷ୍ଟ କରିବା ପାଇଁ ପଦକ୍ଷେପ';
  ...
  String get eyeScanDescription =>
      'ଆପଣ ପାଖାପାଖି ଅଛନ୍ତି! ଆଉ ଗୋଟିଏ ପରୀକ୍ଷା ବାକି ଅଛି। ତା \'ପରେ ନିଜ ଆଖିର ଫଟୋ ଉଠାନ୍ତୁ।';
  ...
  String get eyeScanViewStepsToPerform =>
      'ଆପଣଙ୍କ ଆଖିକୁ କିପରି ସ୍କାନ୍ କରିବେ ତାହା ଜାଣିବା ପାଇଁ ପଦକ୍ଷେପଗୁଡ଼ିକୁ ଦେଖନ୍ତୁ।';

  @override
  String get eyeScanExitDialog =>
      'ଚକ୍ଷୁ ସ୍କାନ୍ ଆପଣଙ୍କ ଚକ୍ଷୁ ସମସ୍ଯ଼ା ବିଷଯ଼ରେ ଅଧିକ ବୁଝିବାରେ ସାହାଯ୍ଯ଼ କରେ। ଆପଣ ପ୍ରକୃତରେ ବାହାରକୁ ଯିବାକୁ ଚାହୁଁଛନ୍ତି କି?';
  ...
  @override
  String get skipButton => 'ସ୍କିପ୍ କରନ୍ତୁ';
  ...
  @override
  String get shareNowButton => 'ବର୍ତ୍ତମାନ ଅଂଶୀଦାର କରନ୍ତୁ';
  ...
  String get homeCarousal1Title =>
      '40 ବର୍ଷ ଏବଂ ତା \'ଠାରୁ ଅଧିକ ବଯ଼ସର ବଯ଼ସ୍କଙ୍କ ମଧ୍ଯ଼ରେ ମୋତିଆବିନ୍ଦୁ ପ୍ରସାର ଏବଂ ଏହା ସହ ଜଡ଼ିତ କାରକ';

  @override
  String get homeCarousal1Description =>
      'ମୋତିଆବିନ୍ଦୁ ଏବଂ ସମ୍ପୃକ୍ତ କାରକଗୁଡ଼ିକର ପ୍ରସାର ଉପରେ ନମୁନା ସଂଗ୍ରହ ପ୍ରକ୍ରିଯ଼ାର ଯୋଜନାବଦ୍ଧ ଉପସ୍ଥାପନା';

  @override
  String get homeCarousal2Title =>
      'ଆଖି ସମ୍ବନ୍ଧୀଯ଼ 7ଟି ସମସ୍ଯ଼ାକୁ ଏଡ଼ାଇ ହେବ ନାହିଁ!';

  @override
  String get homeCarousal2Description =>
      'ପରୀକ୍ଷା ପାଇଁ 7ଟି ଚକ୍ଷୁ ସମସ୍ଯ଼ାଃ ଆଖି ଲାଲ ହେବା, ଆଖିରୁ ପାଣି ବାହାରିବା, ଆଖିରେ ଧଳା ଦାଗ';

  @override
  String get homeCarousal3Title =>
      'ଆଖି ସମସ୍ଯ଼ା। ଏମିତି ଅନେକ ଜିନିଷ ଅଛି ଯାହାକୁ ଆପଣ ଦେଖିପାରିବେ ନାହିଁ।';

  @override
  String get homeCarousal3Description =>
      'କିନ୍ତୁ ଜଣେ ଦୃଷ୍ଟି ଯତ୍ନ ବିଶେଷଜ୍ଞ ଆଖି ସମସ୍ଯ଼ା ଚିହ୍ନଟ କରିପାରିବେ ଏବଂ ପରେ ଜଟିଳତାକୁ ଏଡ଼ାଇବା ପାଇଁ ଠିକ୍ ସମଯ଼ରେ ଚିକିତ୍ସା କରିପାରିବେ।';
  ...
  @override
  String get recentServicesTitle => 'ମୋର ସାମ୍ପ୍ରତିକ ସେବାଗୁଡିକ';
  ...
  @override
  String get appDrawerHelpAndSupport => 'ସହାଯ଼ତା ଏବଂ ସହାଯ଼ତା';
  ...
  String get aboutUsDescription =>
      'Sightconnect ଏକ ବ୍ୟବହାରକାରୀ ବନ୍ଧୁତାମୂଳକ ନେତ୍ର ଯତ୍ନ ଆପ୍ ଅଟେ, ଯାହା ସ୍ୱ ମୂଲ୍ୟାଙ୍କନ ଏବଂ କଲ୍ ଉପରେ ପରାମର୍ଶ ସହିତ ସହାୟତା କରେ।\n\nଆମର ମିଶନର ହୃଦୟରେ ଏକ ପ୍ରତିବଦ୍ଧତା ଅଛି ସମସ୍ତଙ୍କ ପାଇଁ ନେତ୍ର ଯତ୍ନ ପ୍ରାପ୍ୟ କରିବା। ଏହି ଆପ୍ ସମସ୍ତ ଜୀବନର ପଥର ଉପଭୋଗ୍ତାମାନେ ସମାବେଶୀ ଏବଂ ସହଜସୁଲଭ ଭାବେ ଡିଜାଇନ କରାଯାଇଛି, ଯାହା ସେମାନଙ୍କର ବୟସ, ପ୍ରଯୁକ୍ତିଗତ ପୃଷ୍ଠଭୂମି, ଏବଂ ସାମାଜିକ କିମ୍ବା ଆର୍ଥିକ ପୃଷ୍ଠଭୂମି ନିର୍ବିଶେଷରେ। ଆପ୍ ଏବଂ ତାହାର ସମସ୍ତ ସାମଗ୍ରୀ ଇଂରାଜୀ ଏବଂ ଅନ୍ୟାନ୍ୟ ସ୍ଥାନୀୟ ଭାଷାରେ ଉପଲବ୍ଧ। ଏହା ଉପଭୋଗ୍ତାମାନଙ୍କୁ ସ୍ୱ ନେତ୍ର ମୂଲ୍ୟାଙ୍କନ କରିବାରେ ଏବଂ ସମୟମତେ ଚିକିତ୍ସା ପରାମର୍ଶ ପାଇବାରେ ସହାୟତା କରେ। ଆପ୍ ନବୀନତମ ପ୍ରଯୁକ୍ତି ଓ ଟୁଲସ୍ ବ୍ୟବହାର କରି ଆମର ଉପଭୋଗ୍ତାମାନଙ୍କୁ ବୈଯକ୍ତିକୃତ ନେତ୍ର ଯତ୍ନ ସମାଧାନ ପ୍ରଦାନ କରେ। ଏହା ଉପଭୋଗ୍ତାମାନଙ୍କର ଜୀବନ ସୁଗମ କରିବାପାଇଁ ବିଭିନ୍ନ ଧରଣର ବୈଶିଷ୍ଟ୍ୟ ସହିତ ଆସେ।';
  ...
  String get assessmentAndTestsSubtitle =>
      'ଏ ପର୍ଯ୍ଯ଼ନ୍ତ କରାଯାଇଥିବା ମୂଲ୍ଯ଼ାଙ୍କନଗୁଡ଼ିକର ଏକ ସଂକ୍ଷିପ୍ତ ଦୃଶ୍ଯ଼ ଏଠାରେ ଦିଆଯାଇଛି।';
  ...
  String get eyeAssessmentSubtitle =>
      'ଆପଣ, ଆପଣଙ୍କ ବନ୍ଧୁ, ଏବଂ ପରିବାର ସଦସ୍ଯ଼ଙ୍କ ଚକ୍ଷୁ ସମ୍ବନ୍ଧୀଯ଼ ସମସ୍ଯ଼ାଗୁଡ଼ିକୁ ଅଳ୍ପ କିଛି ପର୍ଯ୍ଯ଼ାଯ଼ରେ ମୂଲ୍ଯ଼ାଙ୍କନ କରନ୍ତୁ। ଆପଣଙ୍କ ଚକ୍ଷୁ ସମ୍ବନ୍ଧୀଯ଼ ସମସ୍ଯ଼ା ସମ୍ବନ୍ଧୀଯ଼ ଲକ୍ଷଣଗୁଡ଼ିକୁ ବୁଝିବା ପାଇଁ ଆପଣଙ୍କୁ ଅନେକ ପ୍ରଶ୍ନ ପଚରାଯିବ ଏବଂ ତା \'ପରେ ଦୃଷ୍ଟି ପରୀକ୍ଷା କରାଯିବ।';
  ...
  String get eyeAssessmentBrightnessLabel =>
      'ଉଜ୍ଜ୍ୱଳତା 80 ପ୍ରତିଶତରେ ସ୍ଥିର ହୋଇଛି';

  @override
  String get eyeAssessmentBrightnessError =>
      'ଦଯ଼ାକରି ସ୍ୱଯ଼ଂକ୍ରିଯ଼ ଭାବେ ଉଜ୍ଜ୍ୱଳତାକୁ 80 ପ୍ରତିଶତରେ ସେଟ କରନ୍ତୁ।';

  @override
  String get eyeAssessmentUnsupportedQuestion =>
      'ପ୍ରଶ୍ନ ଏପର୍ଯ୍ଯ଼ନ୍ତ ସମର୍ଥିତ ନୁହେଁ';
  ...
  String get eyeAssessmentPopUpBody =>
      'ଆପଣଙ୍କର ଆଖି ସମ୍ବନ୍ଧୀଯ଼ କୌଣସି ସମସ୍ଯ଼ା ରହିଛି କି?';
  ...
  String get visualAcuityTestInstructionOne =>
      'ଏକ ଭଲ ହାଲୁକା ସ୍ଥାନରେ ଆରାମରେ ବସନ୍ତୁ। ଆପଣ ହଠାତ୍ ଉଜ୍ଜ୍ୱଳତାରେ ପରିବର୍ତ୍ତନ ଅନୁଭବ କରିପାରନ୍ତି, ଚିନ୍ତା କରନ୍ତୁ ନାହିଁ ଯେ ସର୍ବୋତ୍ତମ ଫଳାଫଳ ପ୍ରଦାନ କରିବା ପାଇଁ ସ୍କ୍ରିନ୍ ସ୍ୱଯ଼ଂଚାଳିତ ଉଜ୍ଜ୍ୱଳତାକୁ ସେଟ୍ ହୋଇଛି |';

  @override
  String get visualAcuityTestInstructionTwo =>
      'ନିଶ୍ଚିତ କରନ୍ତୁ ଯେ ଆପଣ ଯନ୍ତ୍ରଟିକୁ ଆଖି ସ୍ତରରେ ଧରିଛନ୍ତି। ଯଦି ଆପଣ ଚଷମା କିମ୍ବା କଣ୍ଟାକ୍ଟ ଲେନ୍ସ ପିନ୍ଧନ୍ତି, ତେବେ ସେଗୁଡ଼ିକୁ ପିନ୍ଧି ରଖନ୍ତୁ।';

  @override
  String get visualAcuityTestInstructionThree =>
      'ସ୍କ୍ରିନ୍ ଠାରୁ ନିଜକୁ 40 ସେ. ମି. ଦୂରରେ ରଖନ୍ତୁ। ଦୂରତା ପରୀକ୍ଷା ସ୍କ୍ରିନରେ ଦେଖାଯିବ।';

  @override
  String get visualAcuityTestInstructionFour =>
      'ଯଦି ଆପଣ ଚଷମା ପିନ୍ଧି ପରୀକ୍ଷା କରୁଛନ୍ତି, କେବଳ ଗୋଟିଏ ଆଖି ପରୀକ୍ଷା କରାଯିବା ସମଯ଼ରେ ଚଷମା ଉପରେ ଆପଣଙ୍କ ହାତରେ ଗୋଟିଏ ଆଖି ଢାଙ୍କି ଦିଅନ୍ତୁ |';
  ...
  @override
  String get eyeAssessmentStepOne => 'ପର୍ଯ୍ଯ଼ାଯ଼ 1-ଚକ୍ଷୁ ମୂଲ୍ଯ଼ାଙ୍କନ ପ୍ରଶ୍ନ';

  @override
  String get eyeAssessmentStepTwo => 'ପର୍ଯ୍ଯ଼ାଯ଼ 2-ଚକ୍ଷୁ ମୂଲ୍ଯ଼ାଙ୍କନ ପ୍ରଶ୍ନ';

  @override
  String get eyeAssessmentStepThree => 'ପର୍ଯ୍ଯ଼ାଯ଼ 3-ଚକ୍ଷୁ ମୂଲ୍ଯ଼ାଙ୍କନ ପ୍ରଶ୍ନ';
  ...
  String get eyeAssessmentCompleteSteps =>
      'ଫଳାଫଳ ଦେଖିବା ପାଇଁ ସମସ୍ତ ପଦକ୍ଷେପ ପୂରଣ କରନ୍ତୁ';

  @override
  String get eyeAssessmentToolTip =>
      'ଦଯ଼ାକରି ନିଶ୍ଚିତ କରନ୍ତୁ ଯେ ଫ୍ଲାସ୍ ବନ୍ଦ ଅଛି ଏବଂ ଉଜ୍ଜ୍ୱଳତା 80 ପ୍ରତିଶତ ସେଟ ହୋଇଛି।';

  @override
  String get eyeScanInstructionOne =>
      'ଫ୍ରେମ୍ ଉପରେ ମୁହଁକୁ ସଠିକ୍ ଭାବରେ ରଖି କ୍ଯ଼ାମେରାକୁ ଧରନ୍ତୁ |';

  @override
  String get eyeScanInstructionTwo =>
      'ଆପଣଙ୍କ ଫୋନର ପଛ କ୍ଯ଼ାମେରା ବ୍ଯ଼ବହାର କରି ଆଖିର ଏକ ଫଟୋ ନିଅନ୍ତୁ।';

  @override
  String get eyeScanInstructionThree =>
      'ଫ୍ଲାସ୍ ଅନ୍ ସହିତ ଏକ ଭଲ ଆଲୋକିତ ସ୍ଥାନରେ ରହିବା ନିଶ୍ଚିତ କରନ୍ତୁ |';

  @override
  String get eyeScanInstructionFour =>
      'ଭଲ କ୍ଯ଼ାପଚର୍ ଏବଂ ସ୍ପଷ୍ଟତା ପାଇଁ, ଚିତ୍ରଟିକୁ କ୍ଲିକ୍ କରିବା ପାଇଁ ଅନ୍ଯ଼ କାହାକୁ କୁହନ୍ତୁ।';

  @override
  String get eyeScanInstructionFive =>
      'ଫଟୋ ଉଠାଇବା ସମଯ଼ରେ ଗୋଟିଏ ଆଖିକୁ ହାତରେ ଢାଙ୍କି ଅନ୍ଯ଼ ଆଖିକୁ ସିଧା ଆଗକୁ ଦେଖନ୍ତୁ।';

  @override
  String get eyeScanInstructionSix =>
      'ଚିତ୍ର ଆରମ୍ଭ କରିବା ପୂର୍ବରୁ ପ୍ଯ଼ାନେଲ୍ ଭିତରେ ଆଖିକୁ କେନ୍ଦ୍ର କରନ୍ତୁ।';

  @override
  String get eyeScanInstructionSeven =>
      'ଫ୍ଲାଶ୍ ବନ୍ଦ ହେବା ପର୍ଯ୍ଯ଼ନ୍ତ ଆଖି ଖୋଲା ରଖନ୍ତୁ, ଯେପର୍ଯ୍ଯ଼ନ୍ତ ଏକ \'ବିପ୍\' ଶବ୍ଦ ଫଟୋର ଶେଷକୁ ସଙ୍କେତ ଦିଏ |';

  @override
  String get eyeAssessmentNote =>
      'ଟିପନ୍ତୁ: ଏଠାରେ ଦେଖାଯାଇଥିବା ପ୍ରତିଛବିଗୁଡ଼ିକ କେବଳ ସୂଚାଇବା ପାଇଁ | ବାସ୍ତବ ଜୀବନରେ ସେଗୁଡ଼ିକ ସମାନ ଭାବରେ ଦେଖାଯାଇନପାରେ |';
  ...
  @override
  String get imageNotCapturedToastMessage => 'ପ୍ରତିଛବି ଧରାଯାଇ ନାହିଁ ';
  ...
  String get eyeCaptureCompletionDialogBody =>
      'ଆପଣ ପରୀକ୍ଷା ସମାପ୍ତ କରିଛନ୍ତି। ଫଳାଫଳ ଦେଖିବା ପାଇଁ ଦଯ଼ାକରି ତଳେ ଥିବା ବଟନ୍ ଉପରେ କ୍ଲିକ୍ କରନ୍ତୁ।';
  ...
  String get eyeCaptureTriageSavedLocally =>
      'ଟ୍ରାଇଏଜ୍ ସ୍ଥାନୀଯ଼ ଭାବରେ ସଂରକ୍ଷିତ ହୋଇଛି';
  ...
  String get assessmentResultPageMoreDetailsText =>
      'ଅଧିକ ବିବରଣୀ ପାଇଁ ନିକଟସ୍ଥ ଭିଜନ ସେଣ୍ଟରକୁ ଯାଆନ୍ତୁ। ଆମର ଭିଜନ ଟେକ୍ନିସିଆନଙ୍କ ସହ କଥା ହେବା ପାଇଁ ଟୋଲ-ଫ୍ରି ନମ୍ବରକୁ କଲ୍ କରନ୍ତୁ।';
  ...
  @override
  String get assessmentResultCardAcuityTest => 'ନେତ୍ରତ୍ଵ\nପରୀକ୍ଷା';
  ...
  @override
  String get assessmentCardRoutineCheckUp => 'ନିଯୁକ୍ତିମତ ଚେକ୍ ଆପ';
  ...
  @override
  String get homeTriageCardTitle => 'ଆମର ଚକ୍ଷୁ ସବୁଥିବା ମୂଲ୍ୟବାନ ସ୍ୱତ୍ବ ।';

  @override
  String get homeTriageCardDescription =>
      'ଚକ୍ଷୁ ପ୍ରସ୍ତୁତ ହେବା ପୂର୍ବରୁ ସମୟରେ ପରୀକ୍ଷା କରନ୍ତୁ ଯାହା ଚକ୍ଷୁ ମୁଖ୍ୟ ବିରୋଧଗ୍ରାସି ରୋକିବା ପାଇଁ ।';
  ...
  String get homeHelplineCardDescrition =>
      'ଅସ୍ପଷ୍ଟ ଦୃଷ୍ଟି ହାନିରେ, ଏହା ଆପତ୍ତି ହେଲାଇନରେ ଏହି ଆପାତକାଲୀରେ କଲ୍ କରନ୍ତୁ';

  @override
  String get inviteCardTitle => 'ଅନ୍ୟାୟିତ କରନ୍ତୁ';

  @override
  String get inviteCardDescription =>
      '5 ବନ୍ଧୁ ଏବଂ ପରିବାରର ସଦସ୍ୟଙ୍କୁ ଆମର ଚକ୍ଷୁ ମୂଲ୍ୟାଂକନ ପାଇଁ ଆମନ୍ତ୍ରିତ କରନ୍ତୁ ଏବଂ ଭବିଷ୍ୟତର ଚକ୍ଷୁ ସମସ୍ୟାରୁ ବଚାଇବାରେ ସହାୟ୍ୟ କରନ୍ତୁ ।';
  ...
  String get triageAlerDialogBoxTitle =>
      'ପୁନର୍ବାର କରିବାକୁ ପଦକ୍ଷେପଗୁଡିକ ଚୟନ କରନ୍ତୁ';
