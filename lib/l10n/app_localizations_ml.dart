...
class AppLocalizationsMl extends AppLocalizations {
  ...
  String get questionnaireExitDialog =>
      'ഈ ചോദ്യങ്ങൾക്ക് ഉത്തരം നൽകുന്നത് നിങ്ങളുടെ കണ്ണിന്റെ പ്രശ്നങ്ങൾ തിരിച്ചറിയാൻ സഹായിക്കും. നിങ്ങൾ ശരിക്കും അതിൽ നിന്ന് പുറത്തുകടക്കാൻ ആഗ്രഹിക്കുന്നുണ്ടോ?';
  ...
  String get visualAcuityDescription =>
      'ഒരു പ്രത്യേക അകലത്തിൽ നിന്ന് ഒരു അക്ഷരത്തിൻ്റെയോ ചിഹ്നത്തിൻ്റെയോ വിശദാംശങ്ങൾ നിങ്ങൾ എത്ര നന്നായി കാണുന്നുവെന്ന് പരിശോധിക്കുന്ന ഒരു നേത്രപരിശോധനയാണ് വിഷ്വൽ അക്വിറ്റി ടെസ്റ്റ്. ഈ പെട്ടെന്നുള്ള പരിശോധന ഇപ്പോൾ ചെയ്യുക!';

  @override
  String get visualAcuityHowToPerform =>
      'വിഷ്വൽ അക്വിറ്റി ടെസ്റ്റ് എങ്ങനെ നടത്താം?';

  @override
  String get visualAcuityViewStepsToPerform =>
      'വിഷ്വൽ അക്വിറ്റി ടെസ്റ്റ് നടത്തുന്നതിനുള്ള ഘട്ടങ്ങൾ കാണുക';

  @override
  String get visualAcuityCompletionDialog =>
      'പൂർത്തിയായി! രണ്ട് കണ്ണുകൾക്കും വിഷ്വൽ അക്വിറ്റി ടെസ്റ്റ് പൂർത്തിയായി. അടുത്തതായി നിങ്ങൾ നിങ്ങളുടെ കണ്ണിന്റെ ഫോട്ടോകൾ എടുക്കേണ്ടതുണ്ട്.';

  @override
  String get visualAcuityExitDialog =>
      'നിങ്ങളുടെ കണ്ണിന്റെ പ്രശ്നത്തെക്കുറിച്ച് മനസിലാക്കാൻ വിഷ്വൽ അക്വിറ്റി ഒരു പ്രധാന പരിശോധനയാണ്. നിങ്ങൾ ശരിക്കും അതിൽ നിന്ന് പുറത്തുകടക്കാൻ ആഗ്രഹിക്കുന്നുണ്ടോ?';
  ...
  String get visualAcuityBothEyeInstructions =>
      'നിങ്ങളുടെ കണ്ണുകളൊന്നും മറയ്ക്കരുത്, രണ്ട് കണ്ണുകളും അടുത്തതായി ദൃശ്യമാകുന്ന ചിഹ്നങ്ങൾ കാണുക.';
  ...
  String get overlayDescription =>
      'ഓരോ ചിഹ്നത്തിന്റെയും ദിശകൾ നിങ്ങൾ എങ്ങനെ മനസ്സിലാക്കുന്നുവെന്നത് ഇവിടെയുണ്ട്.';
  ...
  String get visualAcuityCarouselTitle =>
      'വിഷ്വൽ അക്വിറ്റി ടെസ്റ്റ് നടത്തുന്നതിനുള്ള നടപടികൾ';
  ...
  String get eyeScanDescription =>
      'നിങ്ങൾ അടുത്തിരിക്കുന്നു! ഇനി ഒരു പരീക്ഷണം കൂടി ബാക്കിയുണ്ട്. അടുത്തതായി നിങ്ങളുടെ കണ്ണുകളുടെ ഫോട്ടോകൾ എടുക്കുക.';
  ...
  String get eyeScanViewStepsToPerform =>
      'നിങ്ങളുടെ കണ്ണുകൾ എങ്ങനെ സ്കാൻ ചെയ്യാമെന്ന് അറിയാൻ ഘട്ടങ്ങൾ കാണുക.';

  @override
  String get eyeScanExitDialog =>
      'നിങ്ങളുടെ കണ്ണിന്റെ പ്രശ്നത്തെക്കുറിച്ച് കൂടുതൽ മനസ്സിലാക്കാൻ ഐ സ്കാൻ സഹായിക്കുന്നു. നിങ്ങൾക്ക് ശരിക്കും അതിൽ നിന്ന് പുറത്തുകടക്കാൻ ആഗ്രഹമുണ്ടോ?';
  ...
  String get homeCarousal1Title =>
      '40 വയസും അതിൽ കൂടുതലുമുള്ള മുതിർന്നവരിൽ തിമിരത്തിൻറെ വ്യാപനവും അതുമായി ബന്ധപ്പെട്ട ഘടകങ്ങളും';
  ...
  String get homeCarousal2Title =>
      'കണ്ണിനുണ്ടാകുന്ന 7 പ്രശ്നങ്ങൾ ഒഴിവാക്കരുത്!';
  ...
  String get nearbyVisionCentersNotFound =>
      'കാഴ്ച കേന്ദ്രങ്ങളൊന്നും കണ്ടെത്തിയില്ല';
  ...
  String get privacyPolicyPurposeOfProcessingTitle =>
      'പ്രോസസ്സിംഗിന്റെ ഉദ്ദേശ്യം: നിങ്ങളുടെ നൽകിയ വ്യക്തിഗത ഡാറ്റ ഞങ്ങൾ ചുവടെപ്പറയുന്ന ഉദ്ദേശ്യങ്ങൾക്കായി പ്രോസസ്സ് ചെയ്യുന്നു:';
  ...
  String get privacyPolicyDataTransferDescription =>
      'നിങ്ങൾ പങ്കിട്ട വ്യക്തിഗത ഡാറ്റ ഇന്ത്യയിലെ ഞങ്ങളുടെ അംഗീകൃത സേവന ദാതാവിന്റെ സെർവറായ ഞങ്ങളുടെ ആന്തരിക സെർവറുകളിൽ സംഭരിക്കപ്പെടും.';
  ...
  String get privacyPolicyBottomAppBarLabel =>
      'സ്വകാര്യതാ നയം അംഗീകരിക്കപ്പെട്ടു';
  ...
  String get assessmentAndTestsSubtitle =>
      'ഇതുവരെ നടത്തിയ വിലയിരുത്തലുകളുടെ ഒരു ദ്രുത കാഴ്ച ഇതാ.';

  @override
  String get assessmentAndTestsReportsNotFound =>
      'റിപ്പോർട്ടുകളൊന്നും കണ്ടെത്തിയില്ല';
  ...
  String get eyeAssessmentSubtitle =>
      'നിങ്ങളുടെയും നിങ്ങളുടെ സുഹൃത്തുക്കളുടെയും കുടുംബാംഗങ്ങളുടെയും നേത്രപ്രശ്നങ്ങൾ കുറച്ച് ഘട്ടങ്ങളിലൂടെ വിലയിരുത്തുക. നിങ്ങളുടെ നേത്രപ്രശ്നങ്ങളുമായി ബന്ധപ്പെട്ട ലക്ഷണങ്ങൾ മനസിലാക്കാൻ നിങ്ങളോട് ഒരു കൂട്ടം ചോദ്യങ്ങൾ ചോദിക്കുകയും തുടർന്ന് വിഷ്വൽ ടെസ്റ്റുകൾ നടത്തുകയും ചെയ്യും.';
  ...
  String get eyeAssessmentBrightnessError =>
      'ദയവായി തെളിച്ചം 80 ശതമാനമായി ക്രമീകരിക്കുക';

  @override
  String get eyeAssessmentUnsupportedQuestion =>
      'ചോദ്യം ഇതുവരെ പിന്തുണയ്ക്കുന്നില്ല';
  ...
  String get visualAcuityTestInstructionOne =>
      'നല്ല വെളിച്ചമുള്ള സ്ഥലത്ത് സുഖമായി ഇരിക്കുക. തെളിച്ചത്തിൽ പെട്ടെന്നുള്ള മാറ്റം നിങ്ങൾക്ക് അനുഭവപ്പെട്ടേക്കാം, ഒപ്റ്റിമൽ ഫലം നൽകുന്നതിന് സ്ക്രീൻ ഓട്ടോ-ബ്രൈറ്റ്നസ് ആയി സജ്ജീകരിച്ചിരിക്കുന്നു എന്ന് വിഷമിക്കേണ്ട.';
  ...
  String get visualAcuityTestInstructionThree =>
      'സ്ക്രീനിൽ നിന്ന് 40 സെന്റീമീറ്റർ അകലെ നിൽക്കുക. ടെസ്റ്റ് സ്ക്രീനിൽ ദൂരം കാണിക്കും.';

  @override
  String get visualAcuityTestInstructionFour =>
      'നിങ്ങൾ കണ്ണട ഉപയോഗിച്ച് പരിശോധന നടത്തുകയാണെങ്കിൽ, ഒരു കണ്ണ് മാത്രം പരിശോധിക്കുമ്പോൾ കണ്ണടയ്ക്ക് മുകളിൽ ഒരു കണ്ണ് കൊണ്ട് മൂടുക.';
  ...
  String get eyeAssessmentToolTip =>
      'ഫ്ലാഷ് ഓഫ് ചെയ്തിട്ടുണ്ടെന്നും തെളിച്ചം 80 ശതമാനമായി സജ്ജീകരിച്ചിട്ടുണ്ടെന്നും ഉറപ്പാക്കുക.';

  @override
  String get eyeScanInstructionOne =>
      'ഫ്രെയിമിൽ മുഖം ശരിയായി വെച്ചുകൊണ്ട് ക്യാമറ പിടിക്കുക.';
  ...
  String get eyeScanInstructionFour =>
      'മികച്ച ക്യാപ്ചറിനും വ്യക്തതയ്ക്കും, ചിത്രത്തിൽ ക്ലിക്ക് ചെയ്യാൻ മറ്റൊരാളെ നിയോഗിക്കുക.';

  @override
  String get eyeScanInstructionFive =>
      'ചിത്രം എടുക്കുമ്പോൾ ഒരു കണ്ണ് കൈകൊണ്ട് മൂടുകയും മറ്റേ കണ്ണ് കൊണ്ട് നേരെ മുന്നോട്ട് നോക്കുകയും ചെയ്യുക.';

  @override
  String get eyeScanInstructionSix =>
      'ചിത്രം ആരംഭിക്കുന്നതിന് മുമ്പ് പാനലിനുള്ളിൽ കണ്ണ് കേന്ദ്രീകരിക്കുക.';

  @override
  String get eyeScanInstructionSeven =>
      'ഒരു \'ബീപ്പ്\' ശബ്ദം ഫോട്ടോയുടെ അവസാനത്തെ സൂചിപ്പിക്കുന്നതുവരെ ഫ്ലാഷ് ഓഫ് ആകുന്നതുവരെ കണ്ണുകൾ തുറന്നിടുക.';

  @override
  String get eyeAssessmentNote =>
      'ശ്രദ്ധിക്കുക: ഇവിടെ കാണിച്ചിരിക്കുന്ന ചിത്രങ്ങൾ സൂചനകൾക്ക് മാത്രമുള്ളതാണ്. യഥാർത്ഥ ജീവിതത്തിൽ അവർ ഒരേ രീതിയിൽ പ്രത്യക്ഷപ്പെടണമെന്നില്ല.';
  ...
  String get eyeCaptureCompletionDialogBody =>
      'നിങ്ങൾ പരീക്ഷ പൂർത്തിയാക്കി. ഫലം കാണാൻ താഴെ കൊടുത്തിരിക്കുന്ന ബട്ടണിൽ ക്ലിക്ക് ചെയ്യുക.';
  ...
  String get homeTriageCardTitle =>
      'ഞങ്ങളുടെ കണ്ണുകൾ ഏറ്റവും മൂല്യപ്രാധാന്യമുള്ള ആസ്തികൾ ആണ്.';

  @override
  String get homeTriageCardDescription =>
      'കണ്ണ് പ്രശ്നങ്ങൾ മുമ്പായി സമയത്ത് പരീക്ഷിക്കുകയാണ് നടത്തുന്നത്.';
  ...
  String get homeHelplineCardDescrition =>
      'ഏറ്റവും അപ്രതീക്ഷിത ദൃഷ്ടി ഇഴഞ്ഞ സമയത്ത്, ഈ ആപത്തെത്തുവണമെന്ന് ഈ എയ്ഡ് ഹെൽപ്പ്ലൈൻ അയയ്ക്കുക';
  ...
  String get inviteCardDescription =>
      '5 ആപ്രവാസികൾക്കും കുടുംബസദസ്യര്‍ക്കും അമന്യമാക്കുക, അവരുടെ കണ്ണുകളെ മൂല്യാംകനം ചെയ്യുകയും ഭവിഷ്യത്തിൽ കണ്ണ് പ്രശ്നങ്ങൾ പിന്തുടർന്ന് തടയുകയും ചെയ്യുക.';
