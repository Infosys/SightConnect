...
class AppLocalizationsMl extends AppLocalizations {
  ...
  String get questionnaireExitDialog =>
      'ഈ ചോദ്യങ്ങൾക്ക് ഉത്തരം നൽകുന്നത് നിങ്ങളുടെ കണ്ണിന്റെ പ്രശ്നങ്ങൾ തിരിച്ചറിയാൻ സഹായിക്കും. അസ്സെസ്സ്മെന്റ് ഉപേക്ഷിക്കാൻ നിങ്ങൾ ആഗ്രഹിക്കുന്നുവെന്ന് ഉറപ്പാണോ?';
  ...
  String get visualAcuityDescription =>
      'ഒരു പ്രത്യേക അകലത്തിൽ നിന്ന് ഒരു അക്ഷരത്തിൻ്റെയോ ചിഹ്നത്തിൻ്റെയോ വിശദാംശങ്ങൾ നിങ്ങൾ എത്ര നന്നായി കാണുന്നുവെന്ന് പരിശോധിക്കുന്ന ഒരു നേത്രപരിശോധനയാണിത് . ഈ പരിശോധന ഇപ്പോൾ ചെയ്യുക!';
  ...
  String get visualAcuityViewStepsToPerform =>
      'കാഴ്ച പരിശോധന നടത്തുന്നതിനുള്ള ഘട്ടങ്ങൾ';

  @override
  String get visualAcuityCompletionDialog =>
      'കാഴ്ച പരിശോധന പൂർത്തിയായിരിക്കുന്നു. അടുത്തതായി നിങ്ങളുടെ കണ്ണിന്റെ ഫോട്ടോ എടുക്കലാണ്.';

  @override
  String get visualAcuityExitDialog =>
      'നിങ്ങളുടെ കണ്ണിന്റെ പ്രശ്നത്തെക്കുറിച്ച് മനസിലാക്കാൻ കാഴ്ച പരിശോധന പ്രധാനമാണ്. ഈ പരിശോധന ഉപേക്ഷിക്കാൻ നിങ്ങൾ ആഗ്രഹിക്കുന്നുവെന്ന് ഉറപ്പാണോ?';
  ...
  String get visualAcuityLeftEyeInstructions =>
      'കൺപോളയിൽ അമർത്താതെ നിങ്ങളുടെ വലത് കണ്ണ് കൈകൊണ്ട് മൂടുക. നിങ്ങൾ കണ്ണട ധരിച്ചിട്ടുണ്ടെങ്കിൽ കണ്ണടയ്ക്ക് മുകളിൽ കൈ വയ്ക്കുക.';
  ...
  String get visualAcuityRightEyeInstructions =>
      'കൺപോളയിൽ അമർത്താതെ ഇടത് കണ്ണ് കൈകൊണ്ട് മൂടുക. നിങ്ങൾ കണ്ണട ധരിച്ചിട്ടുണ്ടെങ്കിൽ കണ്ണടയ്ക്ക് മുകളിൽ കൈ വയ്ക്കുക.';
  ...
  String get visualAcuityBothEyeInstructions =>
      'ഇരു കണ്ണുകളും മറയ്ക്കാതെ അടുത്തതായി ദൃശ്യമാകുന്ന ചിഹ്നങ്ങൾ നോക്കുക.';
  ...
  String get overlayDescription =>
      'ഓരോ ചിഹ്നത്തിന്റെയും ദിശ ഇങ്ങനെ മനസ്സിലാക്കാം.';
  ...
  String get eyeScanDescription =>
      'അടുത്തതായി നിങ്ങളുടെ കണ്ണുകളുടെ ഫോട്ടോ എടുക്കുക.';
  ...
  String get eyeScanViewStepsToPerform =>
      'കണ്ണുകൾ സ്കാൻ ചെയ്യുവാനുള്ള ഘട്ടങ്ങൾ.';

  @override
  String get eyeScanExitDialog =>
      'നിങ്ങളുടെ കണ്ണിന്റെ പ്രശ്നത്തെക്കുറിച്ച് കൂടുതൽ മനസ്സിലാക്കാൻ കണ്ണിൻറെ സ്കാൻ സഹായിക്കും. ഈ സ്കാൻ ഉപേക്ഷിക്കാൻ നിങ്ങൾ ആഗ്രഹിക്കുന്നുവെന്ന് ഉറപ്പാണോ?';
  ...
  String get homeCarousal1Title =>
      '40 വയസും അതിൽ കൂടുതലുമുള്ളവർക്കിടയിൽ തിമിര വ്യാപനവും അതുമായി ബന്ധപ്പെട്ട ഘടകങ്ങളും';

  @override
  String get homeCarousal1Description =>
      'തിമിരത്തിൻറെയും അനുബന്ധ ഘടകങ്ങളുടെയും വ്യാപനത്തെക്കുറിച്ചുള്ള സാമ്പിൾ പ്രക്രിയയുടെ ആസൂത്രിത അവതരണം';
  ...
  String get nearbyVisionCentersTitle =>
      'സമീപത്തുള്ള കാഴ്ച പരിശോധന കേന്ദ്രങ്ങൾ';

  @override
  String get nearbyVisionCentersNotFound =>
      'കാഴ്ച പരിശോധന കേന്ദ്രങ്ങളൊന്നും ലഭ്യമല്ല';
  ...
  String get privacyPolicyDataRecipientsTitle =>
      'ഡാറ്റ സ്വീകർത്താക്കൾ/ആക്സസ് ചെയ്യാവുന്നവർഃ';

  @override
  String get privacyPolicyDataRecipientsDescription =>
      'നിങ്ങൾ പങ്കിട്ട വ്യക്തിഗത ഡാറ്റ (സെൻസിറ്റീവ് വ്യക്തിഗത ഡാറ്റ ഉൾപ്പെടെ) അംഗീകൃത എൽവിപിഇഐ ഉദ്യോഗസ്ഥരായ ഡോക്ടർമാർ/നേത്രരോഗവിദഗ്ദ്ധർ, വിഷൻ ടെക്നീഷ്യൻമാർ, വിഷൻ ഗാർഡിയൻമാർ, എൽവിപിഇഐ പ്രതിനിധികൾ, ആന്തരിക/ബാഹ്യ ഓഡിറ്റർമാർ, ബാധകമെങ്കിൽ സർക്കാർ അധികാരികൾ, ഞങ്ങളുടെ അംഗീകൃത സേവന ദാതാവായ ഇൻഫോസിസ് എന്നിവർക്ക് ലഭ്യമാകും.';
  ...
  String get privacyPolicyDataTransferDescription =>
      'നിങ്ങൾ പങ്കിട്ട വ്യക്തിഗത ഡാറ്റ ഇന്ത്യയിലെ ഞങ്ങളുടെ അംഗീകൃത സേവന ദാതാവിന്റെ സർവറുകളിലും ഞങ്ങളുടെ ആന്തരിക സർവറുകളിലും സംഭരിക്കപ്പെടും.';
  ...
  String get privacyPolicyDataSecurityDescription =>
      'നിങ്ങളുടെ സ്വകാര്യ ഡാറ്റ സംരക്ഷിക്കുന്നതിനായി അഡ്മിനിസ്ട്രേറ്റീവ്, ഫിസിക്കൽ സെക്യൂരിറ്റി, സാങ്കേതിക നിയന്ത്രണങ്ങൾ എന്നിവയുൾപ്പെടെ ന്യായമായതും ഉചിതവുമായ സുരക്ഷാ രീതികളും നടപടിക്രമങ്ങളും എൽവിപിഇഐ സ്വീകരിക്കുന്നു.';
  ...
  String get privacyPolicyDataRetentionDescription =>
      'നിയമപരവും ബിസിനസ്സ് ആവശ്യകതകളും അനുസരിച്ച് നിലനിർത്തേണ്ട ആവശ്യമില്ലാത്ത വ്യക്തിഗത ഡാറ്റ സുരക്ഷിതമായ രീതിയിൽ വിനിയോഗിക്കും.';
  ...
  String get assessmentAndTestsSubtitle =>
      'ഇതുവരെ നടത്തിയ വിലയിരുത്തലുകളുടെ ഒരു ദ്രുത കാഴ്ച.';

  @override
  String get assessmentAndTestsReportsNotFound =>
      'റിപ്പോർട്ടുകളൊന്നും ലഭ്യമല്ല';
  ...
  String get eyeAssessmentSubtitle =>
      'നിങ്ങളുടെയും സുഹൃത്തുക്കളുടെയും കുടുംബാംഗങ്ങളുടെയും നേത്രപ്രശ്നങ്ങൾ കുറച്ച് ഘട്ടങ്ങളിലൂടെ വിലയിരുത്തുക. നിങ്ങളുടെ നേത്രപ്രശ്നങ്ങളുമായി ബന്ധപ്പെട്ട ലക്ഷണങ്ങൾ മനസിലാക്കാൻ നിങ്ങളോട് ഒരു കൂട്ടം ചോദ്യങ്ങൾ ചോദിക്കുകയും തുടർന്ന് വിഷ്വൽ ടെസ്റ്റുകൾ നടത്തുകയും ചെയ്യും.';
  ...
  String get eyeAssessmentBrightnessLabel =>
      'സ്ക്രീനിന്റെ തെളിച്ചം 80% ആക്കി മാറ്റിയിട്ടുണ്ട്';

  @override
  String get eyeAssessmentBrightnessError =>
      'ദയവായി സ്ക്രീനിന്റെ തെളിച്ചം 80% ആക്കുക';
  ...
  String get eyeAssessmentPopUpBody =>
      'നിങ്ങൾക്ക് കാഴ്ചയുമായി ബന്ധപ്പെട്ട എന്തെങ്കിലും പ്രശ്നങ്ങളുണ്ടോ?';
  ...
  String get visualAcuityTestInstructionOne =>
      'നല്ല വെളിച്ചമുള്ള സ്ഥലത്ത് ഇരിക്കുക. തെളിച്ചത്തിൽ പെട്ടെന്നുള്ള മാറ്റം നിങ്ങൾക്ക് അനുഭവപ്പെട്ടേക്കാം, ഒപ്റ്റിമൽ ഫലം നൽകുന്നതിന് സ്ക്രീൻ ഓട്ടോ-ബ്രൈറ്റ്നസ് ആയി സജ്ജീകരിച്ചിരിക്കുന്നു.';

  @override
  String get visualAcuityTestInstructionTwo =>
      'നിങ്ങൾ ഉപകരണം കണ്ണിന്റെ തലത്തിൽ പിടിക്കുന്നുവെന്ന് ഉറപ്പാക്കുക. നിങ്ങൾ കണ്ണടയോ കോൺടാക്റ്റ് ലെൻസോ ധരിക്കുന്നുണ്ടെങ്കിൽ അവ ധരിച്ചിരിക്കുക.';

  @override
  String get visualAcuityTestInstructionThree =>
      'സ്ക്രീനിൽ നിന്ന് 40 സെന്റീമീറ്റർ അകലെ നിൽക്കുക. ടെസ്റ്റ് സ്ക്രീനിൽ ദൂരം കാണാവുന്നതാണ്.';

  @override
  String get visualAcuityTestInstructionFour =>
      'നിങ്ങൾ കണ്ണട ഉപയോഗിച്ച് പരിശോധന നടത്തുകയാണെങ്കിൽ, ഒരു കണ്ണ് മാത്രം പരിശോധിക്കുമ്പോൾ കണ്ണടയ്ക്ക് മുകളിൽ കൈ കൊണ്ട് മൂടുക.';
  ...
  String get eyeAssessmentStepThree =>
      'ഘട്ടം 3-നേത്ര അസ്സെസ്സ്മെന്റ് ചോദ്യങ്ങൾ';
  ...
  String get eyeAssessmentCompleteSteps =>
      'ഫലങ്ങൾ കാണുന്നതിന് എല്ലാ ഘട്ടങ്ങളും പൂർത്തിയാക്കുക';

  @override
  String get eyeAssessmentToolTip =>
      'ഫ്ലാഷ് ഓഫ് ചെയ്തിട്ടുണ്ടെന്നും തെളിച്ചം 80% ആക്കി മാറ്റിയിട്ടുണ്ടെന്നും ഉറപ്പാക്കുക.';

  @override
  String get eyeScanInstructionOne =>
      'ഫ്രെയിമിൽ മുഖം ശരിയായി കാണുന്നപോലെ ക്യാമറ പിടിക്കുക.';

  @override
  String get eyeScanInstructionTwo =>
      'നിങ്ങളുടെ ഫോണിന്റെ പിൻ ക്യാമറ ഉപയോഗിച്ച് കണ്ണുകളുടെ ഒരു ചിത്രം എടുക്കുക.';

  @override
  String get eyeScanInstructionThree =>
      'ഫ്ലാഷ് ഓൺ ചെയ്തുകൊണ്ട് നല്ല വെളിച്ചമുള്ള സ്ഥലത്താണെന്ന് ഉറപ്പാക്കുക.';

  @override
  String get eyeScanInstructionFour =>
      'ചിത്രത്തിൻ്റെ ഗുണനിലവാരവും വ്യക്തതയും വർദ്ധിപ്പിക്കുന്നതിന്, ഫോട്ടോ എടുക്കുവാൻ മറ്റൊരാളെ നിയോഗിക്കുക.';

  @override
  String get eyeScanInstructionFive =>
      'ചിത്രം എടുക്കുമ്പോൾ ഒരു കണ്ണ് കൈകൊണ്ട് മറയ്ക്കുകയും മറ്റേ കണ്ണ് കൊണ്ട് നേരെ മുന്നോട്ട് നോക്കുകയും ചെയ്യുക.';

  @override
  String get eyeScanInstructionSix =>
      'സ്കാൻ ആരംഭിക്കുന്നതിന് മുമ്പ് പാനലിനുള്ളിൽ കണ്ണ് കേന്ദ്രീകരിക്കുക.';

  @override
  String get eyeScanInstructionSeven =>
      'ഫ്ലാഷ് ഓഫ് ചെയ്യുന്നതുവരെ നിങ്ങളുടെ കണ്ണുകൾ പൂർണ്ണമായും തുറന്നു പിടിക്കുക, ഫോട്ടോ എടുത്തതായി സൂചിപ്പിക്കുന്ന ഒരു \'ബീപ്പ്\' കേൾക്കുന്നത് വരെ ഇങ്ങനെ തുടരുക.';

  @override
  String get eyeAssessmentNote =>
      'ശ്രദ്ധിക്കുക: ഇവിടെ കാണിച്ചിരിക്കുന്ന ചിത്രങ്ങൾ സൂചനകൾക്ക് മാത്രമുള്ളതാണ്. യഥാർത്ഥത്തിൽ അവ മറ്റു രീതിയിൽ പ്രത്യക്ഷപ്പെടാം.';
  ...
  String get eyeCaptureCompletionDialogBody =>
      'നിങ്ങൾ ടെസ്റ്റ് പൂർത്തിയാക്കി. ഫലം കാണാൻ താഴെ കൊടുത്തിരിക്കുന്ന ബട്ടണിൽ ക്ലിക്ക് ചെയ്യുക.';
  ...
  String get eyeCaptureTriageSavedLocally =>
      'ട്രിയാജ് പ്രാദേശികമായി സേവ് ചെയ്തിരിക്കുന്നു ';
  ...
  String get assessmentResultPageMoreDetailsText =>
      'കൂടുതൽ വിവരങ്ങൾക്ക് അടുത്തുള്ള വിഷൻ സെന്റർ സന്ദർശിക്കുക. ഞങ്ങളുടെ വിഷൻ ടെക്നീഷ്യനുമായി സംസാരിക്കാൻ ടോൾ ഫ്രീ നമ്പറിൽ വിളിക്കുക.';
  ...
  String get swipeGestureError =>
      'തെറ്റായ സ്വൈപ്പ്! ദയവായി വീണ്ടും ശ്രമിക്കുക.';
  ...
  String get homeTriageCardTitle =>
      'നമ്മുടെ കണ്ണുകളാണ് ഏറ്റവും വിലപ്പെട്ട സ്വത്ത്.';

  @override
  String get homeTriageCardDescription =>
      'നേത്രരോഗങ്ങൾ തടയാൻ കൃത്യസമയത്ത് പരിശോധന നടത്തുക.';
  ...
  String get homeHelplineCardDescrition =>
      'പെട്ടെന്ന് കാഴ്ച നഷ്ടപ്പെട്ടാൽ ഈ എമർജൻസി ഹെൽപ്പ് ലൈനിൽ വിളിക്കുക.';
  ...
  String get inviteCardDescription =>
      '5 സുഹൃത്തുക്കളെയും കുടുംബാംഗങ്ങളെയും ക്ഷണിക്കുക, അതുവഴി അവർക്ക് അവരുടെ കണ്ണുകൾ പരിശോധിക്കാനും ഭാവിയിൽ നേത്ര പ്രശ്നങ്ങൾ ഉണ്ടാകാതിരിക്കാനും കഴിയും.';
  ...
  String get triageAlerDialogBoxTitle =>
      'വീണ്ടും ചെയ്യാനുള്ള ഘട്ടങ്ങൾ തിരഞ്ഞെടുക്കുക';
  ...
  String get visualAcuityTestDistanceInstruction =>
      'ക്യാമറ കണ്ണിൽ നിന്ന് 40cm അകലെ സ്ഥാപിക്കുക.';
  ...
  String get privacyPolicyPurposeOfProcessingSubTitle =>
      'താഴെപ്പറയുന്ന ആവശ്യങ്ങൾക്കായി നിങ്ങൾ നൽകുന്ന വ്യക്തിഗത ഡാറ്റ ഞങ്ങൾ പ്രോസസ്സ് ചെയ്യുന്നുഃ';

  @override
  String get visualAcuityTestDistanceInstructionTooClose =>
      'നിങ്ങൾ ക്യാമറയുടെ വളരെ അടുത്താണ്, ക്യാമറ കണ്ണിൽ നിന്ന് 40cm അകലെ സ്ഥാപിക്കുക.';

  @override
  String get visualAcuityTestDistanceInstructionTooFar =>
      'നിങ്ങൾ ക്യാമറയിൽ നിന്ന് വളരെ അകലെയാണ്, ക്യാമറ കണ്ണിൽ നിന്ന് 40cm അകലെ സ്ഥാപിക്കുക.';
  ...
  String get eyeBoxText =>
      'കണ്ണുകൾക്ക് ചുറ്റും പച്ച ബോക്സുകൾ ദൃശ്യമാകുന്നതുവരെ ചിത്രം ക്രമീകരിച്ച് സ്ഥാപിക്കുക. കണ്ണ് അടുത്തേക്ക് നീക്കി ബോക്‌സിൻ്റെ 40% കണ്ണിനാൽ മൂടപ്പെട്ടിരിക്കുന്നുവെന്ന് ഉറപ്പാക്കുക.';
  ...
  String get smsContent =>
      'ഹേയ്! എൻ്റെ കണ്ണുകളെ പരിപാലിക്കാൻ ഞാൻ സൈറ്റ്കണക്ട് ആപ്പ് ഉപയോഗിക്കുന്നു, നിങ്ങളും ഉപയോഗിക്കണം! നിങ്ങളുടെ കണ്ണുകൾ വിലയിരുത്തുകയും സൈറ്റ്കണക്ട് ആപ്പ് ഉപയോഗിച്ച് സമയബന്ധിതമായ ചികിത്സ നേടുകയും ചെയ്യുക. പ്രതിരോധാത്മകമായ ഐക്കെയർ നിങ്ങളുടെ കൈകളിലേക്ക് കൊണ്ടുവരുന്ന സവിശേഷമായ ഒരു ആപ്ലിക്കേഷനാണിത്. ഇപ്പോൾ അത് നേടുകഃ https://healthconnecttech.org/install';

  @override
  String get emailSubject =>
      'സൈറ്റ്കണക്ട് ആപ്പ് ഉപയോഗിച്ച് നിങ്ങളുടെ കണ്ണിന്റെ ആരോഗ്യത്തിന് മുൻഗണന നൽകുക!';
  ...
  String get chatBotDefaultQuerySuggestions =>
      'കണ്ണ് വിലയിരുത്തൽ ആരംഭിക്കുക | സാധാരണ കണ്ണ് പ്രശ്നങ്ങൾ | മെച്ചപ്പെട്ട കാഴ്ചയ്ക്കുള്ള നുറുങ്ങുകൾ';

  @override
  String get chatBotWelcomeMessage =>
      'ഹായ്, ഇന്ന് ഞാൻ നിങ്ങളെ എങ്ങനെ സഹായിക്കും?';
