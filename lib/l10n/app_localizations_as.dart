...
class AppLocalizationsAs extends AppLocalizations {
  ...
  String get questionnaireExitDialog =>
      'এই প্ৰশ্নবোৰৰ উত্তৰে আপোনাৰ চকুৰ সমস্যাবোৰ চিনাক্ত কৰাত সহায় কৰিব। আপুনি সঁচাকৈয়ে বাহিৰ হোৱাটো বিচাৰে নেকি?';
  ...
  String get visualAcuityDescription =>
      'চাক্ষুষ তীক্ষ্ণতা পৰীক্ষা হৈছে চকুৰ পৰীক্ষা যিয়ে আপুনি এটা নিৰ্দিষ্ট দূৰত্বৰ পৰা এখন আখৰ বা চিহ্নৰ বিৱৰণ কিমান ভালদৰে দেখে সেয়া পৰীক্ষা কৰে। এই দ্ৰুত পৰীক্ষাটো এতিয়া কৰক!';

  @override
  String get visualAcuityHowToPerform =>
      'চাক্ষুষ তীক্ষ্ণতা পৰীক্ষা কেনেকৈ সম্পন্ন কৰিব লাগে?';

  @override
  String get visualAcuityViewStepsToPerform =>
      'চাক্ষুষ তীক্ষ্ণতা পৰীক্ষা সম্পন্ন কৰাৰ পদক্ষেপসমূহ চাওক';

  @override
  String get visualAcuityCompletionDialog =>
      'সম্পূৰ্ণ! দুয়োটা চকুৰ বাবে চাক্ষুষ তীক্ষ্ণতা পৰীক্ষা সম্পূৰ্ণ হৈছে। ইয়াৰ পিছত আপুনি আপোনাৰ চকুৰ ফটো ল \'ব লাগিব।';

  @override
  String get visualAcuityExitDialog =>
      'দৃষ্টিশক্তিৰ তীক্ষ্ণতা আপোনাৰ চকুৰ সমস্যাৰ বিষয়ে বুজিবলৈ এক গুৰুত্বপূৰ্ণ পৰীক্ষা। আপুনি সঁচাকৈয়ে বাহিৰলৈ ওলাব বিচাৰে নেকি?';
  ...
  String get visualAcuityLeftEyeInstructions =>
      'চকুৰ পতাত হেঁচা নিদিয়াকৈ সোঁ চকুখন হাতেৰে ঢাকি ৰাখক। যদি আপুনি চশমা পিন্ধি আছে তেন্তে আপোনাৰ হাতখন চশমাৰ ওপৰত ৰাখক।';
  ...
  String get visualAcuityRightEyeInstructions =>
      'চকুৰ পতাত হেঁচা নিদিয়াকৈ বাওঁ চকুখন হাতেৰে ঢাকি ৰাখক। যদি আপুনি চশমা পিন্ধি আছে তেন্তে আপোনাৰ হাতখন চশমাৰ ওপৰত ৰাখক।';
  ...
  String get visualAcuityBothEyeInstructions =>
      'আপোনাৰ কোনো চকু ঢাকিব নালাগে আৰু দুয়ো চকুৰে ওচৰত দেখা দিয়া চিহ্নবোৰ চাব নালাগে।';
  ...
  String get overlayDescription =>
      'ইয়াত আপুনি প্ৰতিটো চিহ্নৰ দিশবোৰ কেনেদৰে বুজি পায়।';
  ...
  String get visualAcuityCarouselTitle =>
      'চাক্ষুষ তীক্ষ্ণতা পৰীক্ষা সম্পন্ন কৰাৰ পদক্ষেপসমূহ';
  ...
  String get eyeScanDescription =>
      'আপুনি ওচৰতে আছে! মাত্ৰ আৰু এটা পৰীক্ষা বাকী আছে। তাৰ পিছত আপোনাৰ চকুৰ ফটোবোৰ কেপচাৰ কৰক।';
  ...
  String get eyeScanViewStepsToPerform =>
      'আপোনাৰ চকু কেনেকৈ স্কেন কৰিব লাগে জানিবলৈ পদক্ষেপসমূহ চাওক।';

  @override
  String get eyeScanExitDialog =>
      'চকুৰ স্কেনে আপোনাৰ চকুৰ সমস্যাৰ বিষয়ে অধিক বুজাত সহায় কৰে। আপুনি সঁচাকৈয়ে বাহিৰলৈ ওলাব বিচাৰে নেকি?';
  ...
  String get homeCarousal1Title =>
      '40 বছৰ আৰু তাতকৈ অধিক বয়সৰ প্ৰাপ্তবয়স্কসকলৰ মাজত ছানি পৰাৰ প্ৰাদুৰ্ভাৱ আৰু ইয়াৰ লগত জড়িত কাৰকসমূহ';

  @override
  String get homeCarousal1Description =>
      'ছানি পৰাৰ প্ৰাদুৰ্ভাৱ আৰু ইয়াৰ লগত জড়িত কাৰকসমূহৰ ওপৰত নমুনা প্ৰক্ৰিয়াৰ পৰিকল্পিত উপস্থাপন';
  ...
  String get homeCarousal3Title =>
      'চকুৰ সমস্যা। এনে বহুতো আছে যিবোৰ আপুনি চাব নোৱাৰে।';
  ...
  String get privacyPolicyDataRecipientsDescription =>
      'আপুনি শ্বেয়াৰ কৰা ব্যক্তিগত তথ্য (স্পৰ্শকাতৰ ব্যক্তিগত তথ্যকে ধৰি) চিকিৎসক/চকুৰোগ বিশেষজ্ঞ, ভিজন টেকনিচিয়ান, ভিজন গাৰ্ডিয়ান, এলভিপিইআইৰ প্ৰতিনিধি, আভ্যন্তৰীণ/বাহ্যিক অডিটাৰ, চৰকাৰী কৰ্তৃপক্ষ য \'ত প্ৰযোজ্য, আৰু আমাৰ অনুমোদিত সেৱা প্ৰদানকাৰী Infosys দৰে অনুমোদিত এলভিপিইআই কৰ্মচাৰীসকলৰ বাবে উপলব্ধ হ\' ব।';
  ...
  String get privacyPolicyDataTransferDescription =>
      'আপুনি ভাগ-বতৰা কৰা ব্যক্তিগত তথ্য আমাৰ আভ্যন্তৰীণ চাৰ্ভাৰ, ভাৰতত থকা আমাৰ অনুমোদিত সেৱা প্ৰদানকাৰীৰ চাৰ্ভাৰত সংৰক্ষণ কৰা হ \'ব।';
  ...
  String get privacyPolicyDataSecurityDescription =>
      'এল. ভি. পি. ই. আই.-এ আপোনাৰ ব্যক্তিগত তথ্য সুৰক্ষিত কৰাৰ বাবে প্ৰশাসনিক, শাৰীৰিক সুৰক্ষা, আৰু কাৰিকৰী নিয়ন্ত্ৰণকে ধৰি যুক্তিসংগত আৰু উপযুক্ত সুৰক্ষা অনুশীলন আৰু প্ৰক্ৰিয়া গ্ৰহণ কৰে।';
  ...
  String get privacyPolicyDataRetentionDescription =>
      'আইনী আৰু ব্যৱসায়িক প্ৰয়োজনীয়তা অনুসৰি আৰু ৰখাৰ প্ৰয়োজন নথকা ব্যক্তিগত তথ্য সুৰক্ষিতভাৱে নিষ্পত্তি কৰা হ \'ব।';
  ...
  String get privacyPolicyDataSubjectRightsDescription =>
      'আপোনাৰ যিকোনো সময়তে আপোনাৰ ব্যক্তিগত তথ্য প্ৰৱেশ আৰু সংশোধন কৰাৰ অধিকাৰ আছে। যিকোনো অনুৰোধ, সমস্যা, উদ্বেগ বা প্ৰশ্নৰ ক্ষেত্ৰত আপুনি ডিএছআৰৰ বাবে জেনেৰিক মেইল আইডি প্ৰদান কৰিবলৈ <এলভিপিইআইলৈ ইমেইল প্ৰেৰণ কৰি এলভি প্ৰসাদ কাৰ্যালয়লৈ যোগাযোগ কৰিব পাৰে।';
  ...
  String get assessmentAndTestsSubtitle =>
      'ইয়াত এতিয়ালৈকে কৰা মূল্যায়নৰ এক দ্ৰুত দৃষ্টিভংগী দিয়া হৈছে।';
  ...
  String get eyeAssessmentSubtitle =>
      'আপোনাৰ, আপোনাৰ বন্ধুবৰ্গৰ, আৰু পৰিয়ালৰ সদস্যসকলৰ চকুৰ সমস্যাবোৰ কেইটামান পৰ্য্যায়ত মূল্যায়ন কৰক। আপোনাৰ চকুৰ সমস্যাৰ সৈতে সম্পৰ্কিত লক্ষণবোৰ বুজিবলৈ আপোনাক কেইবাটাও প্ৰশ্ন সোধা হ \'ব আৰু তাৰ পিছত চাক্ষুষ পৰীক্ষা কৰা হ\' ব।';
  ...
  String get eyeAssessmentBrightnessLabel =>
      'উজ্জ্বলতা 80 শতাংশত নিৰ্ধাৰণ কৰা হৈছে';

  @override
  String get eyeAssessmentBrightnessError =>
      'অনুগ্ৰহ কৰি উজ্জ্বলতাটো হাতেৰে 80 শতাংশত ছেট কৰক';

  @override
  String get eyeAssessmentUnsupportedQuestion =>
      'প্ৰশ্নটো এতিয়াও সমৰ্থন কৰা হোৱা নাই';
  ...
  String get visualAcuityTestInstructionOne =>
      'ভাল পোহৰৰ স্থানত আৰামদায়কভাৱে বহি থাকক। আপুনি হয়তো হঠাৎ উজ্জ্বলতাৰ পৰিৱৰ্তন অনুভৱ কৰিব পাৰে, চিন্তা নকৰিব যে অনুকূল ফলাফল প্ৰদান কৰিবলৈ পৰ্দাটো স্বয়ংক্ৰিয়-উজ্জ্বলতাত সংহতি কৰা হৈছে।';

  @override
  String get visualAcuityTestInstructionTwo =>
      'নিশ্চিত কৰক যে আপুনি যন্ত্ৰটো চকুৰ স্তৰত ধৰি আছে। যদি আপুনি চশমা বা কণ্টেক্ট লেন্স পিন্ধে, সেইবোৰ পিন্ধি ৰাখক।';

  @override
  String get visualAcuityTestInstructionThree =>
      'পৰ্দাৰ পৰা নিজকে 40 ছে. মি. দূৰত্বত ৰাখক। পৰীক্ষা পৰ্দাত দূৰত্ব দেখুওৱা হ \'ব।';
  ...
  String get eyeAssessmentCompleteSteps =>
      'ফলাফল চাবলৈ সকলো পদক্ষেপ সম্পূৰ্ণ কৰক';

  @override
  String get eyeAssessmentToolTip =>
      'অনুগ্ৰহ কৰি নিশ্চিত কৰক যে ফ্লেশটো বন্ধ কৰি দিয়া হৈছে আৰু উজ্জ্বলতা 80 শতাংশত নিৰ্ধাৰণ কৰা হৈছে।';

  @override
  String get eyeScanInstructionOne =>
      'ফ্ৰেমৰ ওপৰত মুখখন ভালদৰে ৰাখি কেমেৰাটো ধৰি ৰাখক।';

  @override
  String get eyeScanInstructionTwo =>
      'আপোনাৰ ফোনৰ পিছফালৰ কেমেৰা ব্যৱহাৰ কৰি চকুৰ এখন ছবি লওক।';

  @override
  String get eyeScanInstructionThree =>
      'ফ্লাছ অন কৰি ভালদৰে পোহৰ দিয়া ঠাইত থকাটো নিশ্চিত কৰক।';

  @override
  String get eyeScanInstructionFour =>
      'ভাল কেপচাৰ আৰু স্পষ্টতাৰ বাবে, ছবিখন ক্লিক কৰিবলৈ আন কাৰোবাক দিয়ক।';

  @override
  String get eyeScanInstructionFive =>
      'ছবিখন লোৱাৰ সময়ত এখন চকু আপোনাৰ হাতেৰে ঢাকি ৰাখক আৰু আনটো চকুৰে পোনকৈ সন্মুখলৈ চাওক।';

  @override
  String get eyeScanInstructionSix =>
      'ছবিখন আৰম্ভ কৰাৰ আগতে পেনেলৰ ভিতৰত চকু কেন্দ্ৰ কৰক।';

  @override
  String get eyeScanInstructionSeven =>
      'ফ্লেছটো বন্ধ নোহোৱালৈকে চকু মুকলি কৰি ৰাখক, যেতিয়ালৈকে \'বীপ\' শব্দই ফটোখনৰ শেষৰ সংকেত নিদিয়ে।';

  @override
  String get eyeAssessmentNote =>
      'বি:দ্ৰ: ইয়াত দেখুওৱা ছবিসমূহ কেৱল ইংগিতৰ বাবেহে। বাস্তৱ জীৱনত হয়তো একে ধৰণে দেখা নাযায়।';
  ...
  String get eyeCaptureCompletionDialogBody =>
      'আপুনি পৰীক্ষাটো সম্পূৰ্ণ কৰিছে। ফলাফল চাবলৈ অনুগ্ৰহ কৰি তলৰ বুটামটোত ক্লিক কৰক।';
  ...
  String get eyeCaptureTriageSavedLocally =>
      'ট্ৰেইজ স্থানীয়ভাৱে সংৰক্ষণ কৰা হৈছে';
  ...
  String get assessmentResultPageMoreDetailsText =>
      'অধিক বিৱৰণৰ বাবে নিকটতম দৃষ্টি কেন্দ্ৰলৈ যাওক। আমাৰ দৃষ্টি প্ৰযুক্তিবিদৰ সৈতে কথা পাতিবলৈ টোল-ফ্ৰী নম্বৰত ফোন কৰক।';
  ...
  String get homeTriageCardDescription =>
      'চক্ষু সমস্যা পূৰ্ববর্তী কৰিবলৈ সময়ত তালক পাওক।';
  ...
  String get homeHelplineCardDescrition =>
      'অচানক চক্ষু হাৰে যাবলৈ, এই জরুৰী সহায়তা হেলপলাইনটো কল কৰক';
  ...
  String get inviteCardDescription =>
      '5টা বন্ধু আৰু পৰিবারজনক আমন্ত্ৰণ কৰক যাতে তাঁদেৰ চক্ষু মূল্যায়ন কৰিব পাৰে আৰু ভবিষ্যতত চক্ষু সমস্যা পূৰ্ববর্তী কৰিব পাৰে।';
  ...
  String get triageAlerDialogBoxTitle =>
      'পুনৰায় কৰিবলৈ পদক্ষেপসমূহ নিৰ্ব্বাচন কৰক';
  ...
  String get visualAcuityTestDistanceInstruction =>
      'কেমেৰাটো চকুৰ পৰা 40 ছে. মি. দূৰত ৰাখক।';
  ...
  String get privacyPolicyPurposeOfProcessingSubTitle =>
      'আমি আপোনাৰ দ্বাৰা প্ৰদান কৰা ব্যক্তিগত তথ্য তলত দিয়া উদ্দেশ্যসমূহৰ বাবে প্ৰক্ৰিয়া কৰোঁ যেনেঃ';

  @override
  String get visualAcuityTestDistanceInstructionTooClose =>
      'আপুনি কেমেৰাৰ অতি ওচৰত আছে, কেমেৰাটো চকুৰ পৰা 40 ছে. মি. দূৰত ৰাখক।';

  @override
  String get visualAcuityTestDistanceInstructionTooFar =>
      'আপুনি কেমেৰাৰ পৰা বহু দূৰত আছে, কেমেৰাটো চকুৰ পৰা 40 ছে. মি. দূৰত ৰাখক।';
  ...
  String get eyeBoxText =>
      'চকুৰ চাৰিওফালে সেউজীয়া বাকচ দেখা নোপোৱালৈকে অনুগ্ৰহ কৰি ছবিখন সলনি কৰক আৰু অৱস্থান কৰক। চকুখন ওচৰলৈ লৈ যাওক আৰু নিশ্চিত কৰক যে বাকচটোৰ 40 শতাংশ চকুৰে আবৃত হৈ আছে।';
  ...
  String get smsContent =>
      'হেৰা! মই মোৰ চকুৰ যত্ন ল \'বলৈ চাইটকনেক্ট এপ ব্যৱহাৰ কৰিছো, আৰু আপুনিও কৰা উচিত! আপোনাৰ চকুৰ মূল্যায়ন কৰক আৰু চাইট কানেক্ট এপৰ জৰিয়তে সময়মতে চিকিৎসা কৰক। এইটো এটা অনন্য এপ যিয়ে আপোনাৰ হাতত প্ৰতিৰোধমূলক চকুৰ যত্ন কঢ়িয়াই আনে। এতিয়া ইয়াক প্ৰাপ্ত কৰকঃ https://healthconnecttech.org/install';

  @override
  String get emailSubject =>
      'চাইট কানেক্ট এপৰ জৰিয়তে আপোনাৰ চকুৰ স্বাস্থ্যক অগ্ৰাধিকাৰ দিয়ক!';
  ...
  String get chatBotDefaultQuerySuggestions =>
      'চকুৰ মূল্যায়ন আৰম্ভ কৰক। সাধাৰণ চকুৰ সমস্যা। দৃষ্টিশক্তি উন্নত কৰাৰ পৰামৰ্শ';

  @override
  String get chatBotWelcomeMessage =>
      'হাই, মই আজি আপোনাক কেনেকৈ সহায় কৰিব পাৰো?';
