...
part 'uhi_search_model.freezed.dart';
part 'uhi_search_model.g.dart';

@freezed
class UhiSearchModel with _$UhiSearchModel {
  const factory UhiSearchModel({
    Context? context,
    Message? message,
  }) = _UhiSearchModel;

  factory UhiSearchModel.fromJson(Map<String, dynamic> json) =>
      _$UhiSearchModelFromJson(json);
}
...
class InstructionsClass with _$InstructionsClass {
  ...
  factory InstructionsClass.fromJson(Map<String, dynamic> json) =>
      _$InstructionsClassFromJson(json);
}
...
class LocationDescriptor with _$LocationDescriptor {
  ...
  factory LocationDescriptor.fromJson(Map<String, dynamic> json) =>
      _$LocationDescriptorFromJson(json);
}
