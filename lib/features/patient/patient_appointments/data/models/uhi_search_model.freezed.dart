...
UhiSearchModel _$UhiSearchModelFromJson(Map<String, dynamic> json) {
  return _UhiSearchModel.fromJson(json);
}

/// @nodoc
mixin _$UhiSearchModel {
  Context? get context => throw _privateConstructorUsedError;
  Message? get message => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $UhiSearchModelCopyWith<UhiSearchModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UhiSearchModelCopyWith<$Res> {
  factory $UhiSearchModelCopyWith(
          UhiSearchModel value, $Res Function(UhiSearchModel) then) =
      _$UhiSearchModelCopyWithImpl<$Res, UhiSearchModel>;
  @useResult
  $Res call({Context? context, Message? message});
...
/// @nodoc
class _$UhiSearchModelCopyWithImpl<$Res, $Val extends UhiSearchModel>
    implements $UhiSearchModelCopyWith<$Res> {
  _$UhiSearchModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_UhiSearchModelCopyWith<$Res>
    implements $UhiSearchModelCopyWith<$Res> {
  factory _$$_UhiSearchModelCopyWith(
          _$_UhiSearchModel value, $Res Function(_$_UhiSearchModel) then) =
      __$$_UhiSearchModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({Context? context, Message? message});
...
/// @nodoc
class __$$_UhiSearchModelCopyWithImpl<$Res>
    extends _$UhiSearchModelCopyWithImpl<$Res, _$_UhiSearchModel>
    implements _$$_UhiSearchModelCopyWith<$Res> {
  __$$_UhiSearchModelCopyWithImpl(
      _$_UhiSearchModel _value, $Res Function(_$_UhiSearchModel) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_UhiSearchModel(
      context: freezed == context
          ? _value.context
          : context // ignore: cast_nullable_to_non_nullable
              as Context?,
...
/// @nodoc
@JsonSerializable()
class _$_UhiSearchModel implements _UhiSearchModel {
  const _$_UhiSearchModel({this.context, this.message});

  factory _$_UhiSearchModel.fromJson(Map<String, dynamic> json) =>
      _$$_UhiSearchModelFromJson(json);
  ...
  @override
  String toString() {
    return 'UhiSearchModel(context: $context, message: $message)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_UhiSearchModelCopyWith<_$_UhiSearchModel> get copyWith =>
      __$$_UhiSearchModelCopyWithImpl<_$_UhiSearchModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_UhiSearchModelToJson(
      this,
    );
  }
}

abstract class _UhiSearchModel implements UhiSearchModel {
  const factory _UhiSearchModel(
      {final Context? context, final Message? message}) = _$_UhiSearchModel;

  factory _UhiSearchModel.fromJson(Map<String, dynamic> json) =
      _$_UhiSearchModel.fromJson;
...
abstract class _Message implements Message {
  const factory _Message({final Intent? intent}) = _$_Message;
...
/// @nodoc
abstract class _$$_IntentCopyWith<$Res> implements $IntentCopyWith<$Res> {
  factory _$$_IntentCopyWith(_$_Intent value, $Res Function(_$_Intent) then) =
      __$$_IntentCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {InstructionsClass? descriptor,
...
/// @nodoc
class __$$_IntentCopyWithImpl<$Res>
    extends _$IntentCopyWithImpl<$Res, _$_Intent>
    implements _$$_IntentCopyWith<$Res> {
  __$$_IntentCopyWithImpl(_$_Intent _value, $Res Function(_$_Intent) _then)
      : super(_value, _then);
...
class _$_Intent implements _Intent {
  ...
  @override
  String toString() {
    return 'Intent(descriptor: $descriptor, provider: $provider, fulfillment: $fulfillment, payment: $payment, category: $category, item: $item, tags: $tags)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, descriptor, provider,
      fulfillment, payment, category, item, tags);

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$_IntentCopyWith<_$_Intent> get copyWith =>
      __$$_IntentCopyWithImpl<_$_Intent>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_IntentToJson(
      this,
    );
  }
}
