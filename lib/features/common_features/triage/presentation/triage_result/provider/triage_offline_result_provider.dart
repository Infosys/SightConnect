...
var triageOfflineResultProvider =
    ChangeNotifierProvider<TriageOfflineResultProvider>((ref) {
  return TriageOfflineResultProvider(
    ref.watch(triageUrgencyRepositoryProvider),
    ref.watch(triageLocalSourceProvider),
  );
});

class TriageOfflineResultProvider extends ChangeNotifier {
  late final TriageUrgencyRepository _triageUrgencyRepository;
  late final TriageLocalSource _triageLocalSource;
  TriageOfflineResultProvider(
