...
class DistanceTopReadingCard extends ConsumerStatefulWidget {
  const DistanceTopReadingCard({
    Key? key,
  }) : super(key: key);

  @override
  ConsumerState<DistanceTopReadingCard> createState() =>
      _TopReadingCardViewState();
}

class _TopReadingCardViewState extends ConsumerState<DistanceTopReadingCard> {
  @override
                          ...
                          children: [
                            ...
                            Consumer(
                              builder: (context, ref, child) {
                                var model =
                                    ref.watch(distanceTumblingTestProvider);
                                return Text(
