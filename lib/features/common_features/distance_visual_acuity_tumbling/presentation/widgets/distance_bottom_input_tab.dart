...
class DistanceBottomInputTab extends StatefulWidget {
  const DistanceBottomInputTab({super.key, required this.tabs});
...
class BottomInputTabState extends State<DistanceBottomInputTab>
