...
var distancevisualAcuityTumblingTestDialogProvider = StateProvider<bool>((ref) {
  return SharedPreferenceService.getDontShowVisualAcuityStatus;
});

class DistanceVisualAcuityTumblingOverlay extends ConsumerStatefulWidget {
  const DistanceVisualAcuityTumblingOverlay({
    super.key,
    required this.child,
  });
  final Widget child;
  ...
  @override
  ConsumerState<DistanceVisualAcuityTumblingOverlay> createState() =>
      _TumblingOverlayState();
}

class _TumblingOverlayState
    extends ConsumerState<DistanceVisualAcuityTumblingOverlay> {
  @override
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        widget.child,
        Visibility(
          visible: !ref.watch(distancevisualAcuityTumblingTestDialogProvider),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const _DistanceTumblingCarousel(),
                      ],
                    ),
                  ),
                ),
...
class _DistanceTumblingCarousel extends HookConsumerWidget {
  const _DistanceTumblingCarousel();
      ...
      children: [
        CarouselSlider.builder(
          ...
          itemBuilder: (context, index, _) {
            return _DistanceTumblingDirectionCard(
            ...
            Consumer(
              builder: (context, ref, child) {
                return TextButton(
                  onPressed: () {
                    ref
                        .read(distancevisualAcuityTumblingTestDialogProvider
                            .notifier)
                        .state = true;
                  },
...
class _DistanceTumblingDirectionCard extends StatelessWidget {
  const _DistanceTumblingDirectionCard({
...
class _DistanceTumblingDirectionRow extends StatelessWidget {
  final int currentIndex;

  const _DistanceTumblingDirectionRow({required this.currentIndex});
