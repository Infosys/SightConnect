...
var distancetumblingLocalSource =
    ChangeNotifierProvider((ref) => DistanceTumblingLocalSourceImpl());

abstract class DistanceTumblingLocalSource {
...
class DistanceTumblingLocalSourceImpl extends ChangeNotifier
    implements DistanceTumblingLocalSource {
  bool isThreeMeter = true;
  bool get getIsThreeMeter => isThreeMeter;

  void setIsThreeMeter(bool value) {
    isThreeMeter = value;
    notifyListeners();
    if (isThreeMeter) {
        _levels = [
    ...
    logger.f("isThreeMeter set to $isThreeMeter");
  }
  ...
  DistanceTumblingLocalSourceImpl() {
  ...
  void mapLevelsToLevelNumber() {
    logger.f("mapping levels inside distance local source");
    for (var level in _levels!) {
