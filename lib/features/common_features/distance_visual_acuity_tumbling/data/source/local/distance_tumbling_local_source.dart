...
var distancetumblingLocalSource =
    Provider((ref) => DistanceTumblingLocalSourceImpl(
...
class DistanceTumblingLocalSourceImpl implements DistanceTumblingLocalSource {
  final GlobalVisualAcuityProvider _globalVisualAcuityProvider;
  ...
  DistanceTumblingLocalSourceImpl(
    this._globalVisualAcuityProvider,
  ) {
   if(_levels==null || _levels!.isEmpty  ){ if (_globalVisualAcuityProvider.isThreeMeter) {
      _levels = [
        Level(
          levelNumber: 0,
          size: 4.3633,
