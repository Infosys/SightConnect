...
class DistanceVoiceAssistCard extends HookConsumerWidget {
  const DistanceVoiceAssistCard({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    ref.listen(distanceTumblingTestProvider, (previous, next) {
