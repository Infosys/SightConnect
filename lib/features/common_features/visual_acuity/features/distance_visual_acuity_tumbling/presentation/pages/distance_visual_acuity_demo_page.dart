...
import '../widgets/distance_visual_acuity_tumbling_overlay.dart';
import 'distance_visual_acuity_face_distance_page.dart';

class DistanceVisualAcuityDemoPage extends HookConsumerWidget {
  const DistanceVisualAcuityDemoPage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    var pointerState =
        ref.watch(distancevisualAcuityTumblingTestDialogProvider);
    ...
    return Scaffold(
      ...
      body: DistanceVisualAcuityTumblingOverlay(
        child: IgnorePointer(
