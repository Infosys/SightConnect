...
class VisionGuardianEyeAssessmentSearchBarChips extends ConsumerWidget {
  const VisionGuardianEyeAssessmentSearchBarChips({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    var tableFilter =
        ref.watch(visionGuardianEyeAssessmentProvider).eyeAssessmenttableFilter;
        ...
        children: [
          for (int index = 0; index < tableFilter.length; index++) ...[
            InkWell(
              onTap: () {
                ref
                    .watch(visionGuardianEyeAssessmentProvider.notifier)
