    ...
    return Card(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            customTextField(data.name, "First Name"),
            const SizedBox(height: AppSize.klheight),
            customTextField(data.middleName, "Middle Name"),
            const SizedBox(height: AppSize.klheight),
            customTextField(data.lastName, "Last Name"),
            const SizedBox(height: AppSize.klheight),
            Padding(
            ...
            const SizedBox(height: AppSize.klheight),
            customTextField(data.abhaid, "HPR ID (Optional)"),
            const SizedBox(height: AppSize.klheight),
            customTextField(data.email, "Email ID"),
          ],
        ),
      ),
    );
