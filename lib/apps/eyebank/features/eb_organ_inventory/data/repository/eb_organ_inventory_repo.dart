...
// GET : Save Request Form
  Future<Either<EBFailure, void>> saveRequestForm(
...
class EBOrganInventoryRepositoryImpl extends EBOrganInventoryRepository {
  ...
  @override
  Future<Either<EBFailure, void>> saveRequestForm(
      EBSubmitFormDataRequestModel requestData) async {
    return EyeBankErrorHandler.handle(() async {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception(response.statusMessage ?? 'Error in saveRequestForm');
      }
    });
  }
}
