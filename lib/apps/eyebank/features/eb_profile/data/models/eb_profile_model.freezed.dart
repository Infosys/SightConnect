...
EBProfileModel _$EBProfileModelFromJson(Map<String, dynamic> json) {
  return _EBProfileModel.fromJson(json);
}

/// @nodoc
mixin _$EBProfileModel {
  @JsonKey(name: "id")
  ...
  @JsonKey(ignore: true)
  $EBProfileModelCopyWith<EBProfileModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $EBProfileModelCopyWith<$Res> {
  factory $EBProfileModelCopyWith(
          EBProfileModel value, $Res Function(EBProfileModel) then) =
      _$EBProfileModelCopyWithImpl<$Res, EBProfileModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$EBProfileModelCopyWithImpl<$Res, $Val extends EBProfileModel>
    implements $EBProfileModelCopyWith<$Res> {
  _$EBProfileModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$EBProfileModelImplCopyWith<$Res>
    implements $EBProfileModelCopyWith<$Res> {
  factory _$$EBProfileModelImplCopyWith(_$EBProfileModelImpl value,
          $Res Function(_$EBProfileModelImpl) then) =
      __$$EBProfileModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$EBProfileModelImplCopyWithImpl<$Res>
    extends _$EBProfileModelCopyWithImpl<$Res, _$EBProfileModelImpl>
    implements _$$EBProfileModelImplCopyWith<$Res> {
  __$$EBProfileModelImplCopyWithImpl(
      _$EBProfileModelImpl _value, $Res Function(_$EBProfileModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$EBProfileModelImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$EBProfileModelImpl implements _EBProfileModel {
  const _$EBProfileModelImpl(
  ...
  factory _$EBProfileModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$EBProfileModelImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$EBProfileModelImplCopyWith<_$EBProfileModelImpl> get copyWith =>
      __$$EBProfileModelImplCopyWithImpl<_$EBProfileModelImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$EBProfileModelImplToJson(
      this,
    );
  }
}

abstract class _EBProfileModel implements EBProfileModel {
  const factory _EBProfileModel(
      ...
      @JsonKey(name: "practiceGrants")
      final List<PracticeGrant>? practiceGrants,
      @JsonKey(name: "osid") final String? osid}) = _$EBProfileModelImpl;

  factory _EBProfileModel.fromJson(Map<String, dynamic> json) =
      _$EBProfileModelImpl.fromJson;
