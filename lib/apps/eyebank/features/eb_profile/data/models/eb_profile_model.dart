...
part 'eb_profile_model.freezed.dart';
part 'eb_profile_model.g.dart';

@freezed
class EBProfileModel with _$EBProfileModel {
  const factory EBProfileModel({
  ...
  factory EBProfileModel.fromJson(Map<String, dynamic> json) =>
      _$EBProfileModelFromJson(json);
}
