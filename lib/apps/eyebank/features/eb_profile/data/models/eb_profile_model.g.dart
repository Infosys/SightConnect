...
_$EBProfileModelImpl _$$EBProfileModelImplFromJson(Map<String, dynamic> json) =>
    _$EBProfileModelImpl(
...
Map<String, dynamic> _$$EBProfileModelImplToJson(
        _$EBProfileModelImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
