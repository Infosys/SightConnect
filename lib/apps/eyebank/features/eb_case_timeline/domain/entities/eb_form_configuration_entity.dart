class EBFormConfigurationEntity {
  final String? name;
  ...
  @override
  String toString() {
    return 'EBFormConfigurationModelEntity(name: $name, version: $version, logoPosition: $logoPosition, formLayoutType: $formLayoutType, pages: $pages)';
  }
}
