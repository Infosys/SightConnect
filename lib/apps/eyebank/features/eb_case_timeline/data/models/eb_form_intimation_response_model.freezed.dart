...
class _$EBFormIntimationResponseModelImpl
  ...
  @override
  String toString() {
    return 'EBFormIntimationResponseModel(timelineName: $timelineName, version: $version, stageVersion: $stageVersion, stageName: $stageName, timelineVersion: $timelineVersion, stage: $stage, name: $name)';
  }
